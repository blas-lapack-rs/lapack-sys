...
extern "C" {
    ...
    pub fn dgetrf_(m: *const c_int, n: *const c_int, a: *mut c_double, lda: *const c_int,
                   ipiv: *mut c_int, info: *mut c_int);
    pub fn cgetrf_(m: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                   ipiv: *mut c_int, info: *mut c_int);
    pub fn zgetrf_(m: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                   ipiv: *mut c_int, info: *mut c_int);
    ...
    pub fn cgttrf_(n: *const c_int, dl: *mut c_float_complex, d: *mut c_float_complex,
                   du: *mut c_float_complex, du2: *mut c_float_complex, ipiv: *mut c_int,
                   info: *mut c_int);
    pub fn zgttrf_(n: *const c_int, dl: *mut c_double_complex, d: *mut c_double_complex,
    ...
    pub fn dpotrf_(uplo: *const c_char, n: *const c_int, a: *mut c_double, lda: *const c_int,
                   info: *mut c_int);
    pub fn cpotrf_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, info: *mut c_int);
    pub fn zpotrf_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, info: *mut c_int);
    ...
    pub fn dpstrf_(uplo: *const c_char, n: *const c_int, a: *mut c_double, lda: *const c_int,
                   ...
                   info: *mut c_int);
    pub fn cpstrf_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, piv: *mut c_int, rank: *mut c_int, tol: *const c_float,
                   work: *mut c_float, info: *mut c_int);
    pub fn zpstrf_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, piv: *mut c_int, rank: *mut c_int, tol: *const c_double,
    ...
    pub fn cpbtrf_(uplo: *const c_char, n: *const c_int, kd: *const c_int,
                   ab: *mut c_float_complex, ldab: *const c_int, info: *mut c_int);
    pub fn zpbtrf_(uplo: *const c_char, n: *const c_int, kd: *const c_int,
                   ab: *mut c_double_complex, ldab: *const c_int, info: *mut c_int);
    ...
    pub fn cpttrf_(n: *const c_int, d: *mut c_float, e: *mut c_float_complex, info: *mut c_int);
    pub fn zpttrf_(n: *const c_int, d: *mut c_double, e: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn csytrf_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, ipiv: *mut c_int, work: *mut c_float_complex,
                   lwork: *const c_int, info: *mut c_int);
    pub fn zsytrf_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, ipiv: *mut c_int, work: *mut c_double_complex,
                   lwork: *const c_int, info: *mut c_int);

    pub fn chetrf_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, ipiv: *mut c_int, work: *mut c_float_complex,
                   lwork: *const c_int, info: *mut c_int);
    pub fn zhetrf_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, ipiv: *mut c_int, work: *mut c_double_complex,
                   lwork: *const c_int, info: *mut c_int);
    ...
    pub fn dsptrf_(uplo: *const c_char, n: *const c_int, ap: *mut c_double, ipiv: *mut c_int,
                   info: *mut c_int);
    pub fn csptrf_(uplo: *const c_char, n: *const c_int, ap: *mut c_float_complex,
                   ipiv: *mut c_int, info: *mut c_int);
    pub fn zsptrf_(uplo: *const c_char, n: *const c_int, ap: *mut c_double_complex,
                   ipiv: *mut c_int, info: *mut c_int);

    pub fn chptrf_(uplo: *const c_char, n: *const c_int, ap: *mut c_float_complex,
                   ipiv: *mut c_int, info: *mut c_int);
    pub fn zhptrf_(uplo: *const c_char, n: *const c_int, ap: *mut c_double_complex,
                   ipiv: *mut c_int, info: *mut c_int);
    ...
    pub fn cgetrs_(trans: *const c_char, n: *const c_int, nrhs: *const c_int,
                   a: *const c_float_complex, lda: *const c_int, ipiv: *const c_int,
                   b: *mut c_float_complex, ldb: *const c_int, info: *mut c_int);
    pub fn zgetrs_(trans: *const c_char, n: *const c_int, nrhs: *const c_int,
                   a: *const c_double_complex, lda: *const c_int, ipiv: *const c_int,
                   b: *mut c_double_complex, ldb: *const c_int, info: *mut c_int);
    ...
    pub fn cgttrs_(trans: *const c_char, n: *const c_int, nrhs: *const c_int,
                   ...
                   du: *const c_float_complex, du2: *const c_float_complex, ipiv: *const c_int,
                   b: *mut c_float_complex, ldb: *const c_int, info: *mut c_int);
    pub fn zgttrs_(trans: *const c_char, n: *const c_int, nrhs: *const c_int,
                   dl: *const c_double_complex, d: *const c_double_complex,
                   du: *const c_double_complex, du2: *const c_double_complex, ipiv: *const c_int,
                   b: *mut c_double_complex, ldb: *const c_int, info: *mut c_int);
    ...
    pub fn cpftrs_(transr: *const c_char, uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                   a: *const c_float_complex, b: *mut c_float_complex, ldb: *const c_int,
                   info: *mut c_int);
    pub fn zpftrs_(transr: *const c_char, uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                   a: *const c_double_complex, b: *mut c_double_complex, ldb: *const c_int,
                   info: *mut c_int);
    ...
    pub fn cpptrs_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                   ap: *const c_float_complex, b: *mut c_float_complex, ldb: *const c_int,
                   info: *mut c_int);
    pub fn zpptrs_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                   ap: *const c_double_complex, b: *mut c_double_complex, ldb: *const c_int,
                   info: *mut c_int);
    ...
    pub fn cpbtrs_(uplo: *const c_char, n: *const c_int, kd: *const c_int, nrhs: *const c_int,
                   ab: *const c_float_complex, ldab: *const c_int, b: *mut c_float_complex,
                   ldb: *const c_int, info: *mut c_int);
    pub fn zpbtrs_(uplo: *const c_char, n: *const c_int, kd: *const c_int, nrhs: *const c_int,
                   ab: *const c_double_complex, ldab: *const c_int, b: *mut c_double_complex,
                   ldb: *const c_int, info: *mut c_int);
    ...
    pub fn cpttrs_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int, d: *const c_float,
                   e: *const c_float_complex, b: *mut c_float_complex, ldb: *const c_int,
                   info: *mut c_int);
    pub fn zpttrs_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int, d: *const c_double,
                   e: *const c_double_complex, b: *mut c_double_complex, ldb: *const c_int,
                   info: *mut c_int);
    ...
    pub fn ctrtrs_(uplo: *const c_char, trans: *const c_char, diag: *const c_char, n: *const c_int,
                   nrhs: *const c_int, a: *const c_float_complex, lda: *const c_int,
                   b: *mut c_float_complex, ldb: *const c_int, info: *mut c_int);
    pub fn ztrtrs_(uplo: *const c_char, trans: *const c_char, diag: *const c_char, n: *const c_int,
                   nrhs: *const c_int, a: *const c_double_complex, lda: *const c_int,
                   b: *mut c_double_complex, ldb: *const c_int, info: *mut c_int);
    ...
    pub fn ctptrs_(uplo: *const c_char, trans: *const c_char, diag: *const c_char, n: *const c_int,
                   nrhs: *const c_int, ap: *const c_float_complex, b: *mut c_float_complex,
                   ldb: *const c_int, info: *mut c_int);
    pub fn ztptrs_(uplo: *const c_char, trans: *const c_char, diag: *const c_char, n: *const c_int,
                   nrhs: *const c_int, ap: *const c_double_complex, b: *mut c_double_complex,
                   ldb: *const c_int, info: *mut c_int);
    ...
    pub fn dgecon_(norm: *const c_char, n: *const c_int, a: *const c_double, lda: *const c_int,
                   ...
                   iwork: *mut c_int, info: *mut c_int);
    pub fn cgecon_(norm: *const c_char, n: *const c_int, a: *const c_float_complex,
                   lda: *const c_int, anorm: *const c_float, rcond: *mut c_float,
                   work: *mut c_float_complex, rwork: *mut c_float, info: *mut c_int);
    pub fn zgecon_(norm: *const c_char, n: *const c_int, a: *const c_double_complex,
    ...
    pub fn cgbcon_(norm: *const c_char, n: *const c_int, kl: *const c_int, ku: *const c_int,
                   ab: *const c_float_complex, ldab: *const c_int, ipiv: *const c_int,
                   anorm: *const c_float, rcond: *mut c_float, work: *mut c_float_complex,
                   rwork: *mut c_float, info: *mut c_int);
    pub fn zgbcon_(norm: *const c_char, n: *const c_int, kl: *const c_int, ku: *const c_int,
                   ab: *const c_double_complex, ldab: *const c_int, ipiv: *const c_int,
                   anorm: *const c_double, rcond: *mut c_double, work: *mut c_double_complex,
    ...
    pub fn dgtcon_(norm: *const c_char, n: *const c_int, dl: *const c_double, d: *const c_double,
                   ...
                   anorm: *const c_double, rcond: *mut c_double, work: *mut c_double,
                   iwork: *mut c_int, info: *mut c_int);
    pub fn cgtcon_(norm: *const c_char, n: *const c_int, dl: *const c_float_complex,
                   d: *const c_float_complex, du: *const c_float_complex,
                   du2: *const c_float_complex, ipiv: *const c_int, anorm: *const c_float,
                   rcond: *mut c_float, work: *mut c_float_complex, info: *mut c_int);
    pub fn zgtcon_(norm: *const c_char, n: *const c_int, dl: *const c_double_complex,
                   d: *const c_double_complex, du: *const c_double_complex,
                   du2: *const c_double_complex, ipiv: *const c_int, anorm: *const c_double,
    ...
    pub fn dpocon_(uplo: *const c_char, n: *const c_int, a: *const c_double, lda: *const c_int,
                   anorm: *const c_double, rcond: *mut c_double, work: *mut c_double,
                   iwork: *mut c_int, info: *mut c_int);
    pub fn cpocon_(uplo: *const c_char, n: *const c_int, a: *const c_float_complex,
                   lda: *const c_int, anorm: *const c_float, rcond: *mut c_float,
                   work: *mut c_float_complex, rwork: *mut c_float, info: *mut c_int);
    pub fn zpocon_(uplo: *const c_char, n: *const c_int, a: *const c_double_complex,
                   lda: *const c_int, anorm: *const c_double, rcond: *mut c_double,
                   work: *mut c_double_complex, rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn dppcon_(uplo: *const c_char, n: *const c_int, ap: *const c_double,
                   anorm: *const c_double, rcond: *mut c_double, work: *mut c_double,
                   iwork: *mut c_int, info: *mut c_int);
    pub fn cppcon_(uplo: *const c_char, n: *const c_int, ap: *const c_float_complex,
                   anorm: *const c_float, rcond: *mut c_float, work: *mut c_float_complex,
                   rwork: *mut c_float, info: *mut c_int);
    pub fn zppcon_(uplo: *const c_char, n: *const c_int, ap: *const c_double_complex,
                   anorm: *const c_double, rcond: *mut c_double, work: *mut c_double_complex,
                   rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn cpbcon_(uplo: *const c_char, n: *const c_int, kd: *const c_int,
                   ab: *const c_float_complex, ldab: *const c_int, anorm: *const c_float,
    ...
    pub fn zpbcon_(uplo: *const c_char, n: *const c_int, kd: *const c_int,
                   ab: *const c_double_complex, ldab: *const c_int, anorm: *const c_double,
    ...
    pub fn cptcon_(n: *const c_int, d: *const c_float, e: *const c_float_complex,
                   anorm: *const c_float, rcond: *mut c_float, rwork: *mut c_float,
                   info: *mut c_int);
    pub fn zptcon_(n: *const c_int, d: *const c_double, e: *const c_double_complex,
    ...
    pub fn dsycon_(uplo: *const c_char, n: *const c_int, a: *const c_double, lda: *const c_int,
                   ...
                   work: *mut c_double, iwork: *mut c_int, info: *mut c_int);
    pub fn csycon_(uplo: *const c_char, n: *const c_int, a: *const c_float_complex,
                   lda: *const c_int, ipiv: *const c_int, anorm: *const c_float,
                   rcond: *mut c_float, work: *mut c_float_complex, info: *mut c_int);
    pub fn zsycon_(uplo: *const c_char, n: *const c_int, a: *const c_double_complex,
                   lda: *const c_int, ipiv: *const c_int, anorm: *const c_double,
                   rcond: *mut c_double, work: *mut c_double_complex, info: *mut c_int);

    pub fn checon_(uplo: *const c_char, n: *const c_int, a: *const c_float_complex,
                   lda: *const c_int, ipiv: *const c_int, anorm: *const c_float,
                   rcond: *mut c_float, work: *mut c_float_complex, info: *mut c_int);
    pub fn zhecon_(uplo: *const c_char, n: *const c_int, a: *const c_double_complex,
                   lda: *const c_int, ipiv: *const c_int, anorm: *const c_double,
                   rcond: *mut c_double, work: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn dspcon_(uplo: *const c_char, n: *const c_int, ap: *const c_double, ipiv: *const c_int,
                   anorm: *const c_double, rcond: *mut c_double, work: *mut c_double,
                   iwork: *mut c_int, info: *mut c_int);
    pub fn cspcon_(uplo: *const c_char, n: *const c_int, ap: *const c_float_complex,
                   ipiv: *const c_int, anorm: *const c_float, rcond: *mut c_float,
                   work: *mut c_float_complex, info: *mut c_int);
    pub fn zspcon_(uplo: *const c_char, n: *const c_int, ap: *const c_double_complex,
                   ipiv: *const c_int, anorm: *const c_double, rcond: *mut c_double,
                   work: *mut c_double_complex, info: *mut c_int);

    pub fn chpcon_(uplo: *const c_char, n: *const c_int, ap: *const c_float_complex,
                   ipiv: *const c_int, anorm: *const c_float, rcond: *mut c_float,
                   work: *mut c_float_complex, info: *mut c_int);
    pub fn zhpcon_(uplo: *const c_char, n: *const c_int, ap: *const c_double_complex,
                   ipiv: *const c_int, anorm: *const c_double, rcond: *mut c_double,
                   work: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn ctrcon_(norm: *const c_char, uplo: *const c_char, diag: *const c_char, n: *const c_int,
                   a: *const c_float_complex, lda: *const c_int, rcond: *mut c_float,
                   work: *mut c_float_complex, rwork: *mut c_float, info: *mut c_int);
    pub fn ztrcon_(norm: *const c_char, uplo: *const c_char, diag: *const c_char, n: *const c_int,
                   a: *const c_double_complex, lda: *const c_int, rcond: *mut c_double,
                   work: *mut c_double_complex, rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn ctpcon_(norm: *const c_char, uplo: *const c_char, diag: *const c_char, n: *const c_int,
                   ap: *const c_float_complex, rcond: *mut c_float, work: *mut c_float_complex,
                   rwork: *mut c_float, info: *mut c_int);
    pub fn ztpcon_(norm: *const c_char, uplo: *const c_char, diag: *const c_char, n: *const c_int,
                   ap: *const c_double_complex, rcond: *mut c_double, work: *mut c_double_complex,
                   rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn ctbcon_(norm: *const c_char, uplo: *const c_char, diag: *const c_char, n: *const c_int,
                   kd: *const c_int, ab: *const c_float_complex, ldab: *const c_int,
                   rcond: *mut c_float, work: *mut c_float_complex, rwork: *mut c_float,
                   info: *mut c_int);
    pub fn ztbcon_(norm: *const c_char, uplo: *const c_char, diag: *const c_char, n: *const c_int,
                   kd: *const c_int, ab: *const c_double_complex, ldab: *const c_int,
                   rcond: *mut c_double, work: *mut c_double_complex, rwork: *mut c_double,
                   info: *mut c_int);
    ...
    pub fn cgerfs_(trans: *const c_char, n: *const c_int, nrhs: *const c_int,
                   a: *const c_float_complex, lda: *const c_int, af: *const c_float_complex,
                   ldaf: *const c_int, ipiv: *const c_int, b: *const c_float_complex,
                   ldb: *const c_int, x: *mut c_float_complex, ldx: *const c_int,
    ...
    pub fn zgerfs_(trans: *const c_char, n: *const c_int, nrhs: *const c_int,
                   a: *const c_double_complex, lda: *const c_int, af: *const c_double_complex,
                   ldaf: *const c_int, ipiv: *const c_int, b: *const c_double_complex,
                   ldb: *const c_int, x: *mut c_double_complex, ldx: *const c_int,
    ...
    pub fn cgerfsx_(trans: *const c_char, equed: *const c_char, n: *const c_int,
                    nrhs: *const c_int, a: *const c_float_complex, lda: *const c_int,
                    af: *const c_float_complex, ldaf: *const c_int, ipiv: *const c_int,
                    r: *const c_float, c: *const c_float, b: *const c_float_complex,
                    ldb: *const c_int, x: *mut c_float_complex, ldx: *const c_int,
                    rcond: *mut c_float, berr: *mut c_float, n_err_bnds: *const c_int,
                    err_bnds_norm: *mut c_float, err_bnds_comp: *mut c_float,
                    nparams: *const c_int, params: *mut c_float, work: *mut c_float_complex,
                    rwork: *mut c_float, info: *mut c_int);
    pub fn zgerfsx_(trans: *const c_char, equed: *const c_char, n: *const c_int,
                    nrhs: *const c_int, a: *const c_double_complex, lda: *const c_int,
                    af: *const c_double_complex, ldaf: *const c_int, ipiv: *const c_int,
                    r: *const c_double, c: *const c_double, b: *const c_double_complex,
                    ldb: *const c_int, x: *mut c_double_complex, ldx: *const c_int,
                    rcond: *mut c_double, berr: *mut c_double, n_err_bnds: *const c_int,
                    err_bnds_norm: *mut c_double, err_bnds_comp: *mut c_double,
                    nparams: *const c_int, params: *mut c_double, work: *mut c_double_complex,
                    rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn cgbrfs_(trans: *const c_char, n: *const c_int, kl: *const c_int, ku: *const c_int,
                   nrhs: *const c_int, ab: *const c_float_complex, ldab: *const c_int,
                   afb: *const c_float_complex, ldafb: *const c_int, ipiv: *const c_int,
    ...
    pub fn zgbrfs_(trans: *const c_char, n: *const c_int, kl: *const c_int, ku: *const c_int,
                   nrhs: *const c_int, ab: *const c_double_complex, ldab: *const c_int,
                   afb: *const c_double_complex, ldafb: *const c_int, ipiv: *const c_int,
                   b: *const c_double_complex, ldb: *const c_int, x: *mut c_double_complex,
    ...
    pub fn cgbrfsx_(trans: *const c_char, equed: *const c_char, n: *const c_int, kl: *const c_int,
                    ku: *const c_int, nrhs: *const c_int, ab: *const c_float_complex,
                    ldab: *const c_int, afb: *const c_float_complex, ldafb: *const c_int,
    ...
    pub fn zgbrfsx_(trans: *const c_char, equed: *const c_char, n: *const c_int, kl: *const c_int,
                    ku: *const c_int, nrhs: *const c_int, ab: *const c_double_complex,
                    ldab: *const c_int, afb: *const c_double_complex, ldafb: *const c_int,
    ...
    pub fn cgtrfs_(trans: *const c_char, n: *const c_int, nrhs: *const c_int,
                   ...
                   du2: *const c_float_complex, ipiv: *const c_int, b: *const c_float_complex,
                   ldb: *const c_int, x: *mut c_float_complex, ldx: *const c_int,
                   ferr: *mut c_float, berr: *mut c_float, work: *mut c_float_complex,
                   rwork: *mut c_float, info: *mut c_int);
    pub fn zgtrfs_(trans: *const c_char, n: *const c_int, nrhs: *const c_int,
                   ...
                   du2: *const c_double_complex, ipiv: *const c_int, b: *const c_double_complex,
                   ldb: *const c_int, x: *mut c_double_complex, ldx: *const c_int,
                   ferr: *mut c_double, berr: *mut c_double, work: *mut c_double_complex,
                   rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn cporfs_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                   a: *const c_float_complex, lda: *const c_int, af: *const c_float_complex,
                   ldaf: *const c_int, b: *const c_float_complex, ldb: *const c_int,
                   x: *mut c_float_complex, ldx: *const c_int, ferr: *mut c_float,
    ...
    pub fn zporfs_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                   a: *const c_double_complex, lda: *const c_int, af: *const c_double_complex,
                   ldaf: *const c_int, b: *const c_double_complex, ldb: *const c_int,
                   x: *mut c_double_complex, ldx: *const c_int, ferr: *mut c_double,
    ...
    pub fn cporfsx_(uplo: *const c_char, equed: *const c_char, n: *const c_int, nrhs: *const c_int,
                    a: *const c_float_complex, lda: *const c_int, af: *const c_float_complex,
                    ldaf: *const c_int, s: *const c_float, b: *const c_float_complex,
                    ldb: *const c_int, x: *mut c_float_complex, ldx: *const c_int,
                    rcond: *mut c_float, berr: *mut c_float, n_err_bnds: *const c_int,
                    err_bnds_norm: *mut c_float, err_bnds_comp: *mut c_float,
                    nparams: *const c_int, params: *mut c_float, work: *mut c_float_complex,
    ...
    pub fn zporfsx_(uplo: *const c_char, equed: *const c_char, n: *const c_int, nrhs: *const c_int,
                    a: *const c_double_complex, lda: *const c_int, af: *const c_double_complex,
                    ldaf: *const c_int, s: *const c_double, b: *const c_double_complex,
                    ldb: *const c_int, x: *mut c_double_complex, ldx: *const c_int,
                    rcond: *mut c_double, berr: *mut c_double, n_err_bnds: *const c_int,
                    err_bnds_norm: *mut c_double, err_bnds_comp: *mut c_double,
                    nparams: *const c_int, params: *mut c_double, work: *mut c_double_complex,
    ...
    pub fn cpbrfs_(uplo: *const c_char, n: *const c_int, kd: *const c_int, nrhs: *const c_int,
                   ab: *const c_float_complex, ldab: *const c_int, afb: *const c_float_complex,
                   ldafb: *const c_int, b: *const c_float_complex, ldb: *const c_int,
                   x: *mut c_float_complex, ldx: *const c_int, ferr: *mut c_float,
                   berr: *mut c_float, work: *mut c_float_complex, rwork: *mut c_float,
                   info: *mut c_int);
    pub fn zpbrfs_(uplo: *const c_char, n: *const c_int, kd: *const c_int, nrhs: *const c_int,
                   ab: *const c_double_complex, ldab: *const c_int, afb: *const c_double_complex,
                   ldafb: *const c_int, b: *const c_double_complex, ldb: *const c_int,
                   x: *mut c_double_complex, ldx: *const c_int, ferr: *mut c_double,
                   berr: *mut c_double, work: *mut c_double_complex, rwork: *mut c_double,
                   info: *mut c_int);
    ...
    pub fn zptrfs_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int, d: *const c_double,
                   e: *const c_double_complex, df: *const c_double, ef: *const c_double_complex,
                   b: *const c_double_complex, ldb: *const c_int, x: *mut c_double_complex,
                   ldx: *const c_int, ferr: *mut c_double, berr: *mut c_double,
                   work: *mut c_double_complex, rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn csprfs_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                   ap: *const c_float_complex, afp: *const c_float_complex, ipiv: *const c_int,
                   b: *const c_float_complex, ldb: *const c_int, x: *mut c_float_complex,
                   ldx: *const c_int, ferr: *mut c_float, berr: *mut c_float,
                   work: *mut c_float_complex, rwork: *mut c_float, info: *mut c_int);
    pub fn zsprfs_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                   ap: *const c_double_complex, afp: *const c_double_complex, ipiv: *const c_int,
                   b: *const c_double_complex, ldb: *const c_int, x: *mut c_double_complex,
                   ldx: *const c_int, ferr: *mut c_double, berr: *mut c_double,
                   work: *mut c_double_complex, rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn ctrrfs_(uplo: *const c_char, trans: *const c_char, diag: *const c_char, n: *const c_int,
                   nrhs: *const c_int, a: *const c_float_complex, lda: *const c_int,
                   b: *const c_float_complex, ldb: *const c_int, x: *const c_float_complex,
                   ldx: *const c_int, ferr: *mut c_float, berr: *mut c_float,
                   work: *mut c_float_complex, rwork: *mut c_float, info: *mut c_int);
    pub fn ztrrfs_(uplo: *const c_char, trans: *const c_char, diag: *const c_char, n: *const c_int,
                   nrhs: *const c_int, a: *const c_double_complex, lda: *const c_int,
                   b: *const c_double_complex, ldb: *const c_int, x: *const c_double_complex,
                   ldx: *const c_int, ferr: *mut c_double, berr: *mut c_double,
                   work: *mut c_double_complex, rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn ctprfs_(uplo: *const c_char, trans: *const c_char, diag: *const c_char, n: *const c_int,
                   nrhs: *const c_int, ap: *const c_float_complex, b: *const c_float_complex,
                   ldb: *const c_int, x: *const c_float_complex, ldx: *const c_int,
                   ferr: *mut c_float, berr: *mut c_float, work: *mut c_float_complex,
                   rwork: *mut c_float, info: *mut c_int);
    pub fn ztprfs_(uplo: *const c_char, trans: *const c_char, diag: *const c_char, n: *const c_int,
                   nrhs: *const c_int, ap: *const c_double_complex, b: *const c_double_complex,
                   ldb: *const c_int, x: *const c_double_complex, ldx: *const c_int,
                   ferr: *mut c_double, berr: *mut c_double, work: *mut c_double_complex,
                   rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn ctbrfs_(uplo: *const c_char, trans: *const c_char, diag: *const c_char, n: *const c_int,
                   kd: *const c_int, nrhs: *const c_int, ab: *const c_float_complex,
                   ldab: *const c_int, b: *const c_float_complex, ldb: *const c_int,
                   x: *const c_float_complex, ldx: *const c_int, ferr: *mut c_float,
                   berr: *mut c_float, work: *mut c_float_complex, rwork: *mut c_float,
                   info: *mut c_int);
    pub fn ztbrfs_(uplo: *const c_char, trans: *const c_char, diag: *const c_char, n: *const c_int,
                   kd: *const c_int, nrhs: *const c_int, ab: *const c_double_complex,
                   ldab: *const c_int, b: *const c_double_complex, ldb: *const c_int,
                   x: *const c_double_complex, ldx: *const c_int, ferr: *mut c_double,
                   berr: *mut c_double, work: *mut c_double_complex, rwork: *mut c_double,
                   info: *mut c_int);
    ...
    pub fn cgetri_(n: *const c_int, a: *mut c_float_complex, lda: *const c_int, ipiv: *const c_int,
                   work: *mut c_float_complex, lwork: *const c_int, info: *mut c_int);
    pub fn zgetri_(n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                   ipiv: *const c_int, work: *mut c_double_complex, lwork: *const c_int,
                   info: *mut c_int);
    ...
    pub fn dpotri_(uplo: *const c_char, n: *const c_int, a: *mut c_double, lda: *const c_int,
                   info: *mut c_int);
    pub fn cpotri_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, info: *mut c_int);
    pub fn zpotri_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, info: *mut c_int);
    ...
    pub fn csytri_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, ipiv: *const c_int, work: *mut c_float_complex,
                   info: *mut c_int);
    pub fn zsytri_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, ipiv: *const c_int, work: *mut c_double_complex,
                   info: *mut c_int);

    pub fn chetri_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, ipiv: *const c_int, work: *mut c_float_complex,
                   info: *mut c_int);
    pub fn zhetri_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, ipiv: *const c_int, work: *mut c_double_complex,
                   info: *mut c_int);
    ...
    pub fn dsptri_(uplo: *const c_char, n: *const c_int, ap: *mut c_double, ipiv: *const c_int,
                   work: *mut c_double, info: *mut c_int);
    pub fn csptri_(uplo: *const c_char, n: *const c_int, ap: *mut c_float_complex,
                   ipiv: *const c_int, work: *mut c_float_complex, info: *mut c_int);
    pub fn zsptri_(uplo: *const c_char, n: *const c_int, ap: *mut c_double_complex,
                   ipiv: *const c_int, work: *mut c_double_complex, info: *mut c_int);

    pub fn chptri_(uplo: *const c_char, n: *const c_int, ap: *mut c_float_complex,
                   ipiv: *const c_int, work: *mut c_float_complex, info: *mut c_int);
    pub fn zhptri_(uplo: *const c_char, n: *const c_int, ap: *mut c_double_complex,
                   ipiv: *const c_int, work: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn ctrtri_(uplo: *const c_char, diag: *const c_char, n: *const c_int,
                   a: *mut c_float_complex, lda: *const c_int, info: *mut c_int);
    pub fn ztrtri_(uplo: *const c_char, diag: *const c_char, n: *const c_int,
                   a: *mut c_double_complex, lda: *const c_int, info: *mut c_int);
    ...
    pub fn ctftri_(transr: *const c_char, uplo: *const c_char, diag: *const c_char,
                   n: *const c_int, a: *mut c_float_complex, info: *mut c_int);
    pub fn ztftri_(transr: *const c_char, uplo: *const c_char, diag: *const c_char,
                   n: *const c_int, a: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn cgeequ_(m: *const c_int, n: *const c_int, a: *const c_float_complex, lda: *const c_int,
                   r: *mut c_float, c: *mut c_float, rowcnd: *mut c_float, colcnd: *mut c_float,
                   amax: *mut c_float, info: *mut c_int);
    pub fn zgeequ_(m: *const c_int, n: *const c_int, a: *const c_double_complex, lda: *const c_int,
                   r: *mut c_double, c: *mut c_double, rowcnd: *mut c_double,
                   colcnd: *mut c_double, amax: *mut c_double, info: *mut c_int);
    ...
    pub fn dgeequb_(m: *const c_int, n: *const c_int, a: *const c_double, lda: *const c_int,
                    r: *mut c_double, c: *mut c_double, rowcnd: *mut c_double,
                    colcnd: *mut c_double, amax: *mut c_double, info: *mut c_int);
    pub fn cgeequb_(m: *const c_int, n: *const c_int, a: *const c_float_complex, lda: *const c_int,
                    r: *mut c_float, c: *mut c_float, rowcnd: *mut c_float, colcnd: *mut c_float,
                    amax: *mut c_float, info: *mut c_int);
    pub fn zgeequb_(m: *const c_int, n: *const c_int, a: *const c_double_complex,
    ...
    pub fn cgbequ_(m: *const c_int, n: *const c_int, kl: *const c_int, ku: *const c_int,
                   ab: *const c_float_complex, ldab: *const c_int, r: *mut c_float,
                   c: *mut c_float, rowcnd: *mut c_float, colcnd: *mut c_float, amax: *mut c_float,
                   info: *mut c_int);
    pub fn zgbequ_(m: *const c_int, n: *const c_int, kl: *const c_int, ku: *const c_int,
                   ab: *const c_double_complex, ldab: *const c_int, r: *mut c_double,
    ...
    pub fn cpoequ_(n: *const c_int, a: *const c_float_complex, lda: *const c_int, s: *mut c_float,
                   scond: *mut c_float, amax: *mut c_float, info: *mut c_int);
    pub fn zpoequ_(n: *const c_int, a: *const c_double_complex, lda: *const c_int,
    ...
    pub fn dpoequb_(n: *const c_int, a: *const c_double, lda: *const c_int, s: *mut c_double,
                    scond: *mut c_double, amax: *mut c_double, info: *mut c_int);
    pub fn cpoequb_(n: *const c_int, a: *const c_float_complex, lda: *const c_int, s: *mut c_float,
                    scond: *mut c_float, amax: *mut c_float, info: *mut c_int);
    pub fn zpoequb_(n: *const c_int, a: *const c_double_complex, lda: *const c_int,
                    s: *mut c_double, scond: *mut c_double, amax: *mut c_double, info: *mut c_int);
    ...
    pub fn dppequ_(uplo: *const c_char, n: *const c_int, ap: *const c_double, s: *mut c_double,
                   scond: *mut c_double, amax: *mut c_double, info: *mut c_int);
    pub fn cppequ_(uplo: *const c_char, n: *const c_int, ap: *const c_float_complex,
                   s: *mut c_float, scond: *mut c_float, amax: *mut c_float, info: *mut c_int);
    pub fn zppequ_(uplo: *const c_char, n: *const c_int, ap: *const c_double_complex,
                   s: *mut c_double, scond: *mut c_double, amax: *mut c_double, info: *mut c_int);
    ...
    pub fn cpbequ_(uplo: *const c_char, n: *const c_int, kd: *const c_int,
                   ab: *const c_float_complex, ldab: *const c_int, s: *mut c_float,
                   scond: *mut c_float, amax: *mut c_float, info: *mut c_int);
    pub fn zpbequ_(uplo: *const c_char, n: *const c_int, kd: *const c_int,
                   ab: *const c_double_complex, ldab: *const c_int, s: *mut c_double,
                   scond: *mut c_double, amax: *mut c_double, info: *mut c_int);
    ...
    pub fn dsyequb_(uplo: *const c_char, n: *const c_int, a: *const c_double, lda: *const c_int,
                    ...
                    work: *mut c_double, info: *mut c_int);
    pub fn csyequb_(uplo: *const c_char, n: *const c_int, a: *const c_float_complex,
                    lda: *const c_int, s: *mut c_float, scond: *mut c_float, amax: *mut c_float,
                    work: *mut c_float_complex, info: *mut c_int);
    pub fn zsyequb_(uplo: *const c_char, n: *const c_int, a: *const c_double_complex,
                    lda: *const c_int, s: *mut c_double, scond: *mut c_double, amax: *mut c_double,
                    work: *mut c_double_complex, info: *mut c_int);

    pub fn cheequb_(uplo: *const c_char, n: *const c_int, a: *const c_float_complex,
                    lda: *const c_int, s: *mut c_float, scond: *mut c_float, amax: *mut c_float,
                    work: *mut c_float_complex, info: *mut c_int);
    pub fn zheequb_(uplo: *const c_char, n: *const c_int, a: *const c_double_complex,
                    lda: *const c_int, s: *mut c_double, scond: *mut c_double, amax: *mut c_double,
                    work: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn cgesv_(n: *const c_int, nrhs: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                  ipiv: *mut c_int, b: *mut c_float_complex, ldb: *const c_int, info: *mut c_int);
    pub fn zgesv_(n: *const c_int, nrhs: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                  ipiv: *mut c_int, b: *mut c_double_complex, ldb: *const c_int, info: *mut c_int);
    ...
    pub fn dsgesv_(n: *const c_int, nrhs: *const c_int, a: *mut c_double, lda: *const c_int,
                   ...
                   info: *mut c_int);
    pub fn zcgesv_(n: *const c_int, nrhs: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, ipiv: *mut c_int, b: *const c_double_complex,
                   ldb: *const c_int, x: *mut c_double_complex, ldx: *const c_int,
                   work: *mut c_double_complex, swork: *mut c_float_complex, rwork: *mut c_double,
    ...
    pub fn cgesvx_(fact: *const c_char, trans: *const c_char, n: *const c_int, nrhs: *const c_int,
                   a: *mut c_float_complex, lda: *const c_int, af: *mut c_float_complex,
                   ldaf: *const c_int, ipiv: *mut c_int, equed: *mut c_char, r: *mut c_float,
                   c: *mut c_float, b: *mut c_float_complex, ldb: *const c_int,
                   x: *mut c_float_complex, ldx: *const c_int, rcond: *mut c_float,
                   ferr: *mut c_float, berr: *mut c_float, work: *mut c_float_complex,
                   rwork: *mut c_float, info: *mut c_int);
    pub fn zgesvx_(fact: *const c_char, trans: *const c_char, n: *const c_int, nrhs: *const c_int,
                   a: *mut c_double_complex, lda: *const c_int, af: *mut c_double_complex,
                   ldaf: *const c_int, ipiv: *mut c_int, equed: *mut c_char, r: *mut c_double,
                   c: *mut c_double, b: *mut c_double_complex, ldb: *const c_int,
                   x: *mut c_double_complex, ldx: *const c_int, rcond: *mut c_double,
                   ferr: *mut c_double, berr: *mut c_double, work: *mut c_double_complex,
                   rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn cgbsvx_(fact: *const c_char, trans: *const c_char, n: *const c_int, kl: *const c_int,
                   ku: *const c_int, nrhs: *const c_int, ab: *mut c_float_complex,
                   ldab: *const c_int, afb: *mut c_float_complex, ldafb: *const c_int,
                   ipiv: *mut c_int, equed: *mut c_char, r: *mut c_float, c: *mut c_float,
                   b: *mut c_float_complex, ldb: *const c_int, x: *mut c_float_complex,
    ...
    pub fn zgbsvx_(fact: *const c_char, trans: *const c_char, n: *const c_int, kl: *const c_int,
                   ku: *const c_int, nrhs: *const c_int, ab: *mut c_double_complex,
                   ldab: *const c_int, afb: *mut c_double_complex, ldafb: *const c_int,
                   ipiv: *mut c_int, equed: *mut c_char, r: *mut c_double, c: *mut c_double,
                   b: *mut c_double_complex, ldb: *const c_int, x: *mut c_double_complex,
    ...
    pub fn cgtsv_(n: *const c_int, nrhs: *const c_int, dl: *mut c_float_complex,
                  d: *mut c_float_complex, du: *mut c_float_complex, b: *mut c_float_complex,
                  ldb: *const c_int, info: *mut c_int);
    pub fn zgtsv_(n: *const c_int, nrhs: *const c_int, dl: *mut c_double_complex,
                  d: *mut c_double_complex, du: *mut c_double_complex, b: *mut c_double_complex,
                  ldb: *const c_int, info: *mut c_int);
    ...
    pub fn cgtsvx_(fact: *const c_char, trans: *const c_char, n: *const c_int, nrhs: *const c_int,
                   dl: *const c_float_complex, d: *const c_float_complex,
                   du: *const c_float_complex, dlf: *mut c_float_complex, df: *mut c_float_complex,
                   duf: *mut c_float_complex, du2: *mut c_float_complex, ipiv: *mut c_int,
                   b: *const c_float_complex, ldb: *const c_int, x: *mut c_float_complex,
                   ldx: *const c_int, rcond: *mut c_float, ferr: *mut c_float, berr: *mut c_float,
                   work: *mut c_float_complex, rwork: *mut c_float, info: *mut c_int);
    ...
    pub fn cposv_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                  a: *mut c_float_complex, lda: *const c_int, b: *mut c_float_complex,
                  ldb: *const c_int, info: *mut c_int);
    pub fn zposv_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                  a: *mut c_double_complex, lda: *const c_int, b: *mut c_double_complex,
                  ldb: *const c_int, info: *mut c_int);
    ...
    pub fn zcposv_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                   a: *mut c_double_complex, lda: *const c_int, b: *const c_double_complex,
                   ldb: *const c_int, x: *mut c_double_complex, ldx: *const c_int,
                   work: *mut c_double_complex, swork: *mut c_float_complex, rwork: *mut c_double,
                   iter: *mut c_int, info: *mut c_int);
    ...
    pub fn cposvx_(fact: *const c_char, uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                   a: *mut c_float_complex, lda: *const c_int, af: *mut c_float_complex,
                   ldaf: *const c_int, equed: *mut c_char, s: *mut c_float,
                   b: *mut c_float_complex, ldb: *const c_int, x: *mut c_float_complex,
                   ldx: *const c_int, rcond: *mut c_float, ferr: *mut c_float, berr: *mut c_float,
                   work: *mut c_float_complex, rwork: *mut c_float, info: *mut c_int);
    ...
    pub fn cppsv_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                  ap: *mut c_float_complex, b: *mut c_float_complex, ldb: *const c_int,
                  info: *mut c_int);
    pub fn zppsv_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                  ap: *mut c_double_complex, b: *mut c_double_complex, ldb: *const c_int,
                  info: *mut c_int);
    ...
    pub fn cppsvx_(fact: *const c_char, uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                   ...
                   s: *mut c_float, b: *mut c_float_complex, ldb: *const c_int,
                   x: *mut c_float_complex, ldx: *const c_int, rcond: *mut c_float,
                   ferr: *mut c_float, berr: *mut c_float, work: *mut c_float_complex,
                   rwork: *mut c_float, info: *mut c_int);
    pub fn zppsvx_(fact: *const c_char, uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                   ...
                   s: *mut c_double, b: *mut c_double_complex, ldb: *const c_int,
                   x: *mut c_double_complex, ldx: *const c_int, rcond: *mut c_double,
                   ferr: *mut c_double, berr: *mut c_double, work: *mut c_double_complex,
                   rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn cpbsv_(uplo: *const c_char, n: *const c_int, kd: *const c_int, nrhs: *const c_int,
                  ab: *mut c_float_complex, ldab: *const c_int, b: *mut c_float_complex,
                  ldb: *const c_int, info: *mut c_int);
    pub fn zpbsv_(uplo: *const c_char, n: *const c_int, kd: *const c_int, nrhs: *const c_int,
                  ab: *mut c_double_complex, ldab: *const c_int, b: *mut c_double_complex,
                  ldb: *const c_int, info: *mut c_int);
    ...
    pub fn cpbsvx_(fact: *const c_char, uplo: *const c_char, n: *const c_int, kd: *const c_int,
                   nrhs: *const c_int, ab: *mut c_float_complex, ldab: *const c_int,
                   afb: *mut c_float_complex, ldafb: *const c_int, equed: *mut c_char,
                   s: *mut c_float, b: *mut c_float_complex, ldb: *const c_int,
                   x: *mut c_float_complex, ldx: *const c_int, rcond: *mut c_float,
                   ferr: *mut c_float, berr: *mut c_float, work: *mut c_float_complex,
                   rwork: *mut c_float, info: *mut c_int);
    pub fn zpbsvx_(fact: *const c_char, uplo: *const c_char, n: *const c_int, kd: *const c_int,
                   nrhs: *const c_int, ab: *mut c_double_complex, ldab: *const c_int,
                   afb: *mut c_double_complex, ldafb: *const c_int, equed: *mut c_char,
                   s: *mut c_double, b: *mut c_double_complex, ldb: *const c_int,
                   x: *mut c_double_complex, ldx: *const c_int, rcond: *mut c_double,
                   ferr: *mut c_double, berr: *mut c_double, work: *mut c_double_complex,
                   rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn dptsv_(n: *const c_int, nrhs: *const c_int, d: *mut c_double, e: *mut c_double,
                  b: *mut c_double, ldb: *const c_int, info: *mut c_int);
    pub fn cptsv_(n: *const c_int, nrhs: *const c_int, d: *mut c_float, e: *mut c_float_complex,
                  b: *mut c_float_complex, ldb: *const c_int, info: *mut c_int);
    pub fn zptsv_(n: *const c_int, nrhs: *const c_int, d: *mut c_double, e: *mut c_double_complex,
                  b: *mut c_double_complex, ldb: *const c_int, info: *mut c_int);
    ...
    pub fn csysv_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                  a: *mut c_float_complex, lda: *const c_int, ipiv: *mut c_int,
                  b: *mut c_float_complex, ldb: *const c_int, work: *mut c_float_complex,
                  lwork: *const c_int, info: *mut c_int);
    pub fn zsysv_(uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                  a: *mut c_double_complex, lda: *const c_int, ipiv: *mut c_int,
                  b: *mut c_double_complex, ldb: *const c_int, work: *mut c_double_complex,
                  lwork: *const c_int, info: *mut c_int);
    ...
    pub fn csysvx_(fact: *const c_char, uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                   a: *const c_float_complex, lda: *const c_int, af: *mut c_float_complex,
                   ldaf: *const c_int, ipiv: *mut c_int, b: *const c_float_complex,
                   ldb: *const c_int, x: *mut c_float_complex, ldx: *const c_int,
    ...
    pub fn zsysvx_(fact: *const c_char, uplo: *const c_char, n: *const c_int, nrhs: *const c_int,
                   a: *const c_double_complex, lda: *const c_int, af: *mut c_double_complex,
                   ldaf: *const c_int, ipiv: *mut c_int, b: *const c_double_complex,
                   ldb: *const c_int, x: *mut c_double_complex, ldx: *const c_int,
                   rcond: *mut c_double, ferr: *mut c_double, berr: *mut c_double,
    ...
    pub fn cgeqrf_(m: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                   tau: *mut c_float_complex, work: *mut c_float_complex, lwork: *const c_int,
                   info: *mut c_int);
    pub fn zgeqrf_(m: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                   tau: *mut c_double_complex, work: *mut c_double_complex, lwork: *const c_int,
                   info: *mut c_int);
    ...
    pub fn cgeqpf_(m: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                   jpvt: *mut c_int, tau: *mut c_float_complex, work: *mut c_float_complex,
                   rwork: *mut c_float, info: *mut c_int);
    pub fn zgeqpf_(m: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
    ...
    pub fn dgeqp3_(m: *const c_int, n: *const c_int, a: *mut c_double, lda: *const c_int,
                   ...
                   info: *mut c_int);
    pub fn cgeqp3_(m: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                   jpvt: *mut c_int, tau: *mut c_float_complex, work: *mut c_float_complex,
                   lwork: *const c_int, rwork: *mut c_float, info: *mut c_int);
    pub fn zgeqp3_(m: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                   jpvt: *mut c_int, tau: *mut c_double_complex, work: *mut c_double_complex,
    ...
    pub fn cungqr_(m: *const c_int, n: *const c_int, k: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, tau: *const c_float_complex, work: *mut c_float_complex,
                   lwork: *const c_int, info: *mut c_int);
    pub fn zungqr_(m: *const c_int, n: *const c_int, k: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, tau: *const c_double_complex, work: *mut c_double_complex,
                   lwork: *const c_int, info: *mut c_int);
    ...
    pub fn cunmqr_(side: *const c_char, trans: *const c_char, m: *const c_int, n: *const c_int,
                   ...
                   tau: *const c_float_complex, c: *mut c_float_complex, ldc: *const c_int,
                   work: *mut c_float_complex, lwork: *const c_int, info: *mut c_int);
    pub fn zunmqr_(side: *const c_char, trans: *const c_char, m: *const c_int, n: *const c_int,
                   ...
                   tau: *const c_double_complex, c: *mut c_double_complex, ldc: *const c_int,
                   work: *mut c_double_complex, lwork: *const c_int, info: *mut c_int);
    ...
    pub fn dgelqf_(m: *const c_int, n: *const c_int, a: *mut c_double, lda: *const c_int,
                   tau: *mut c_double, work: *mut c_double, lwork: *const c_int, info: *mut c_int);
    pub fn cgelqf_(m: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                   tau: *mut c_float_complex, work: *mut c_float_complex, lwork: *const c_int,
                   info: *mut c_int);
    pub fn zgelqf_(m: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                   tau: *mut c_double_complex, work: *mut c_double_complex, lwork: *const c_int,
                   info: *mut c_int);
    ...
    pub fn cunglq_(m: *const c_int, n: *const c_int, k: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, tau: *const c_float_complex, work: *mut c_float_complex,
                   lwork: *const c_int, info: *mut c_int);
    pub fn zunglq_(m: *const c_int, n: *const c_int, k: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, tau: *const c_double_complex, work: *mut c_double_complex,
                   lwork: *const c_int, info: *mut c_int);
    ...
    pub fn dgeqlf_(m: *const c_int, n: *const c_int, a: *mut c_double, lda: *const c_int,
                   tau: *mut c_double, work: *mut c_double, lwork: *const c_int, info: *mut c_int);
    pub fn cgeqlf_(m: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                   tau: *mut c_float_complex, work: *mut c_float_complex, lwork: *const c_int,
                   info: *mut c_int);
    pub fn zgeqlf_(m: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                   tau: *mut c_double_complex, work: *mut c_double_complex, lwork: *const c_int,
                   info: *mut c_int);
    ...
    pub fn dorgql_(m: *const c_int, n: *const c_int, k: *const c_int, a: *mut c_double,
                   lda: *const c_int, tau: *const c_double, work: *mut c_double,
                   lwork: *const c_int, info: *mut c_int);
    pub fn cungql_(m: *const c_int, n: *const c_int, k: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, tau: *const c_float_complex, work: *mut c_float_complex,
                   lwork: *const c_int, info: *mut c_int);
    pub fn zungql_(m: *const c_int, n: *const c_int, k: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, tau: *const c_double_complex, work: *mut c_double_complex,
                   lwork: *const c_int, info: *mut c_int);
    ...
    pub fn dgerqf_(m: *const c_int, n: *const c_int, a: *mut c_double, lda: *const c_int,
                   tau: *mut c_double, work: *mut c_double, lwork: *const c_int, info: *mut c_int);
    pub fn cgerqf_(m: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                   tau: *mut c_float_complex, work: *mut c_float_complex, lwork: *const c_int,
                   info: *mut c_int);
    pub fn zgerqf_(m: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                   tau: *mut c_double_complex, work: *mut c_double_complex, lwork: *const c_int,
                   info: *mut c_int);
    ...
    pub fn dorgrq_(m: *const c_int, n: *const c_int, k: *const c_int, a: *mut c_double,
                   lda: *const c_int, tau: *const c_double, work: *mut c_double,
                   lwork: *const c_int, info: *mut c_int);
    pub fn cungrq_(m: *const c_int, n: *const c_int, k: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, tau: *const c_float_complex, work: *mut c_float_complex,
                   lwork: *const c_int, info: *mut c_int);
    pub fn zungrq_(m: *const c_int, n: *const c_int, k: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, tau: *const c_double_complex, work: *mut c_double_complex,
                   lwork: *const c_int, info: *mut c_int);
    ...
    pub fn dtzrzf_(m: *const c_int, n: *const c_int, a: *mut c_double, lda: *const c_int,
                   tau: *mut c_double, work: *mut c_double, lwork: *const c_int, info: *mut c_int);
    pub fn ctzrzf_(m: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                   tau: *mut c_float_complex, work: *mut c_float_complex, lwork: *const c_int,
                   info: *mut c_int);
    pub fn ztzrzf_(m: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                   tau: *mut c_double_complex, work: *mut c_double_complex, lwork: *const c_int,
                   info: *mut c_int);
    ...
    pub fn cunmrz_(side: *const c_char, trans: *const c_char, m: *const c_int, n: *const c_int,
                   k: *const c_int, l: *const c_int, a: *const c_float_complex, lda: *const c_int,
                   tau: *const c_float_complex, c: *mut c_float_complex, ldc: *const c_int,
                   work: *mut c_float_complex, lwork: *const c_int, info: *mut c_int);
    pub fn zunmrz_(side: *const c_char, trans: *const c_char, m: *const c_int, n: *const c_int,
                   k: *const c_int, l: *const c_int, a: *const c_double_complex, lda: *const c_int,
                   tau: *const c_double_complex, c: *mut c_double_complex, ldc: *const c_int,
                   work: *mut c_double_complex, lwork: *const c_int, info: *mut c_int);
    ...
    pub fn cggqrf_(n: *const c_int, m: *const c_int, p: *const c_int, a: *mut c_float_complex,
                   ...
                   lwork: *const c_int, info: *mut c_int);
    pub fn zggqrf_(n: *const c_int, m: *const c_int, p: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, taua: *mut c_double_complex, b: *mut c_double_complex,
                   ldb: *const c_int, taub: *mut c_double_complex, work: *mut c_double_complex,
                   lwork: *const c_int, info: *mut c_int);
    ...
    pub fn cggrqf_(m: *const c_int, p: *const c_int, n: *const c_int, a: *mut c_float_complex,
                   ...
                   ldb: *const c_int, taub: *mut c_float_complex, work: *mut c_float_complex,
                   lwork: *const c_int, info: *mut c_int);
    pub fn zggrqf_(m: *const c_int, p: *const c_int, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, taua: *mut c_double_complex, b: *mut c_double_complex,
                   ldb: *const c_int, taub: *mut c_double_complex, work: *mut c_double_complex,
                   lwork: *const c_int, info: *mut c_int);
    ...
    pub fn dgebrd_(m: *const c_int, n: *const c_int, a: *mut c_double, lda: *const c_int,
                   ...
                   work: *mut c_double, lwork: *const c_int, info: *mut c_int);
    pub fn cgebrd_(m: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                   d: *mut c_float, e: *mut c_float, tauq: *mut c_float_complex,
                   taup: *mut c_float_complex, work: *mut c_float_complex, lwork: *const c_int,
                   info: *mut c_int);
    pub fn zgebrd_(m: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                   d: *mut c_double, e: *mut c_double, tauq: *mut c_double_complex,
                   taup: *mut c_double_complex, work: *mut c_double_complex, lwork: *const c_int,
                   info: *mut c_int);
    ...
    pub fn cgbbrd_(vect: *const c_char, m: *const c_int, n: *const c_int, ncc: *const c_int,
                   kl: *const c_int, ku: *const c_int, ab: *mut c_float_complex,
                   ldab: *const c_int, d: *mut c_float, e: *mut c_float, q: *mut c_float_complex,
                   ldq: *const c_int, pt: *mut c_float_complex, ldpt: *const c_int,
                   c: *mut c_float_complex, ldc: *const c_int, work: *mut c_float_complex,
                   rwork: *mut c_float, info: *mut c_int);
    pub fn zgbbrd_(vect: *const c_char, m: *const c_int, n: *const c_int, ncc: *const c_int,
                   kl: *const c_int, ku: *const c_int, ab: *mut c_double_complex,
                   ldab: *const c_int, d: *mut c_double, e: *mut c_double,
                   q: *mut c_double_complex, ldq: *const c_int, pt: *mut c_double_complex,
                   ldpt: *const c_int, c: *mut c_double_complex, ldc: *const c_int,
                   work: *mut c_double_complex, rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn cungbr_(vect: *const c_char, m: *const c_int, n: *const c_int, k: *const c_int,
                   a: *mut c_float_complex, lda: *const c_int, tau: *const c_float_complex,
                   work: *mut c_float_complex, lwork: *const c_int, info: *mut c_int);
    pub fn zungbr_(vect: *const c_char, m: *const c_int, n: *const c_int, k: *const c_int,
                   a: *mut c_double_complex, lda: *const c_int, tau: *const c_double_complex,
                   work: *mut c_double_complex, lwork: *const c_int, info: *mut c_int);

    pub fn cunmbr_(vect: *const c_char, side: *const c_char, trans: *const c_char, m: *const c_int,
                   n: *const c_int, k: *const c_int, a: *const c_float_complex, lda: *const c_int,
                   tau: *const c_float_complex, c: *mut c_float_complex, ldc: *const c_int,
                   work: *mut c_float_complex, lwork: *const c_int, info: *mut c_int);
    pub fn zunmbr_(vect: *const c_char, side: *const c_char, trans: *const c_char, m: *const c_int,
                   n: *const c_int, k: *const c_int, a: *const c_double_complex, lda: *const c_int,
                   tau: *const c_double_complex, c: *mut c_double_complex, ldc: *const c_int,
                   work: *mut c_double_complex, lwork: *const c_int, info: *mut c_int);
    ...
    pub fn cbdsqr_(uplo: *const c_char, n: *const c_int, ncvt: *const c_int, nru: *const c_int,
                   ncc: *const c_int, d: *mut c_float, e: *mut c_float, vt: *mut c_float_complex,
                   ldvt: *const c_int, u: *mut c_float_complex, ldu: *const c_int,
                   c: *mut c_float_complex, ldc: *const c_int, rwork: *mut c_float,
                   info: *mut c_int);
    pub fn zbdsqr_(uplo: *const c_char, n: *const c_int, ncvt: *const c_int, nru: *const c_int,
                   ncc: *const c_int, d: *mut c_double, e: *mut c_double,
                   vt: *mut c_double_complex, ldvt: *const c_int, u: *mut c_double_complex,
                   ldu: *const c_int, c: *mut c_double_complex, ldc: *const c_int,
                   rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn chetrd_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, d: *mut c_float, e: *mut c_float, tau: *mut c_float_complex,
                   work: *mut c_float_complex, lwork: *const c_int, info: *mut c_int);
    pub fn zhetrd_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, d: *mut c_double, e: *mut c_double,
                   tau: *mut c_double_complex, work: *mut c_double_complex, lwork: *const c_int,
                   info: *mut c_int);

    pub fn cungtr_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, tau: *const c_float_complex, work: *mut c_float_complex,
                   lwork: *const c_int, info: *mut c_int);
    pub fn zungtr_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, tau: *const c_double_complex, work: *mut c_double_complex,
                   lwork: *const c_int, info: *mut c_int);
    ...
    pub fn cupgtr_(uplo: *const c_char, n: *const c_int, ap: *const c_float_complex,
                   ...
                   work: *mut c_float_complex, info: *mut c_int);
    pub fn zupgtr_(uplo: *const c_char, n: *const c_int, ap: *const c_double_complex,
                   tau: *const c_double_complex, q: *mut c_double_complex, ldq: *const c_int,
                   work: *mut c_double_complex, info: *mut c_int);

    pub fn cupmtr_(side: *const c_char, uplo: *const c_char, trans: *const c_char, m: *const c_int,
                   n: *const c_int, ap: *const c_float_complex, tau: *const c_float_complex,
                   c: *mut c_float_complex, ldc: *const c_int, work: *mut c_float_complex,
                   info: *mut c_int);
    pub fn zupmtr_(side: *const c_char, uplo: *const c_char, trans: *const c_char, m: *const c_int,
                   n: *const c_int, ap: *const c_double_complex, tau: *const c_double_complex,
                   c: *mut c_double_complex, ldc: *const c_int, work: *mut c_double_complex,
                   info: *mut c_int);
    ...
    pub fn chbtrd_(vect: *const c_char, uplo: *const c_char, n: *const c_int, kd: *const c_int,
                   ab: *mut c_float_complex, ldab: *const c_int, d: *mut c_float, e: *mut c_float,
                   q: *mut c_float_complex, ldq: *const c_int, work: *mut c_float_complex,
                   info: *mut c_int);
    pub fn zhbtrd_(vect: *const c_char, uplo: *const c_char, n: *const c_int, kd: *const c_int,
                   ab: *mut c_double_complex, ldab: *const c_int, d: *mut c_double,
                   e: *mut c_double, q: *mut c_double_complex, ldq: *const c_int,
                   work: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn cstemr_(jobz: *const c_char, range: *const c_char, n: *const c_int, d: *mut c_float,
                   e: *mut c_float, vl: *const c_float, vu: *const c_float, il: *const c_int,
                   iu: *const c_int, m: *mut c_int, w: *mut c_float, z: *mut c_float_complex,
                   ldz: *const c_int, nzc: *const c_int, isuppz: *mut c_int, tryrac: *mut c_int,
                   work: *mut c_float, lwork: *const c_int, iwork: *mut c_int,
                   liwork: *const c_int, info: *mut c_int);
    pub fn zstemr_(jobz: *const c_char, range: *const c_char, n: *const c_int, d: *mut c_double,
                   e: *mut c_double, vl: *const c_double, vu: *const c_double, il: *const c_int,
                   iu: *const c_int, m: *mut c_int, w: *mut c_double, z: *mut c_double_complex,
                   ldz: *const c_int, nzc: *const c_int, isuppz: *mut c_int, tryrac: *mut c_int,
                   work: *mut c_double, lwork: *const c_int, iwork: *mut c_int,
                   liwork: *const c_int, info: *mut c_int);
    ...
    pub fn cstedc_(compz: *const c_char, n: *const c_int, d: *mut c_float, e: *mut c_float,
                   z: *mut c_float_complex, ldz: *const c_int, work: *mut c_float_complex,
    ...
    pub fn zstedc_(compz: *const c_char, n: *const c_int, d: *mut c_double, e: *mut c_double,
                   z: *mut c_double_complex, ldz: *const c_int, work: *mut c_double_complex,
    ...
    pub fn cstegr_(jobz: *const c_char, range: *const c_char, n: *const c_int, d: *mut c_float,
                   e: *mut c_float, vl: *const c_float, vu: *const c_float, il: *const c_int,
                   iu: *const c_int, abstol: *const c_float, m: *mut c_int, w: *mut c_float,
                   z: *mut c_float_complex, ldz: *const c_int, isuppz: *mut c_int,
                   work: *mut c_float, lwork: *const c_int, iwork: *mut c_int,
                   liwork: *const c_int, info: *mut c_int);
    ...
    pub fn chegst_(itype: *const c_int, uplo: *const c_char, n: *const c_int,
                   a: *mut c_float_complex, lda: *const c_int, b: *const c_float_complex,
                   ldb: *const c_int, info: *mut c_int);
    ...
    pub fn chbgst_(vect: *const c_char, uplo: *const c_char, n: *const c_int, ka: *const c_int,
                   kb: *const c_int, ab: *mut c_float_complex, ldab: *const c_int,
                   bb: *const c_float_complex, ldbb: *const c_int, x: *mut c_float_complex,
                   ldx: *const c_int, work: *mut c_float_complex, rwork: *mut c_float,
                   info: *mut c_int);
    pub fn zhbgst_(vect: *const c_char, uplo: *const c_char, n: *const c_int, ka: *const c_int,
                   kb: *const c_int, ab: *mut c_double_complex, ldab: *const c_int,
                   bb: *const c_double_complex, ldbb: *const c_int, x: *mut c_double_complex,
                   ldx: *const c_int, work: *mut c_double_complex, rwork: *mut c_double,
                   info: *mut c_int);
    ...
    pub fn dgehrd_(n: *const c_int, ilo: *const c_int, ihi: *const c_int, a: *mut c_double,
                   ...
                   info: *mut c_int);
    pub fn cgehrd_(n: *const c_int, ilo: *const c_int, ihi: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, tau: *mut c_float_complex, work: *mut c_float_complex,
                   lwork: *const c_int, info: *mut c_int);
    pub fn zgehrd_(n: *const c_int, ilo: *const c_int, ihi: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, tau: *mut c_double_complex, work: *mut c_double_complex,
                   lwork: *const c_int, info: *mut c_int);
    ...
    pub fn cunghr_(n: *const c_int, ilo: *const c_int, ihi: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, tau: *const c_float_complex, work: *mut c_float_complex,
                   lwork: *const c_int, info: *mut c_int);
    pub fn zunghr_(n: *const c_int, ilo: *const c_int, ihi: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, tau: *const c_double_complex, work: *mut c_double_complex,
                   lwork: *const c_int, info: *mut c_int);

    pub fn cunmhr_(side: *const c_char, trans: *const c_char, m: *const c_int, n: *const c_int,
                   ilo: *const c_int, ihi: *const c_int, a: *const c_float_complex,
                   lda: *const c_int, tau: *const c_float_complex, c: *mut c_float_complex,
                   ldc: *const c_int, work: *mut c_float_complex, lwork: *const c_int,
                   info: *mut c_int);
    pub fn zunmhr_(side: *const c_char, trans: *const c_char, m: *const c_int, n: *const c_int,
                   ilo: *const c_int, ihi: *const c_int, a: *const c_double_complex,
                   lda: *const c_int, tau: *const c_double_complex, c: *mut c_double_complex,
                   ldc: *const c_int, work: *mut c_double_complex, lwork: *const c_int,
                   info: *mut c_int);
    ...
    pub fn cgebal_(job: *const c_char, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                   ilo: *mut c_int, ihi: *mut c_int, scale: *mut c_float, info: *mut c_int);
    pub fn zgebal_(job: *const c_char, n: *const c_int, a: *mut c_double_complex,
    ...
    pub fn cgebak_(job: *const c_char, side: *const c_char, n: *const c_int, ilo: *const c_int,
                   ...
                   v: *mut c_float_complex, ldv: *const c_int, info: *mut c_int);
    pub fn zgebak_(job: *const c_char, side: *const c_char, n: *const c_int, ilo: *const c_int,
                   ...
                   v: *mut c_double_complex, ldv: *const c_int, info: *mut c_int);
    ...
    pub fn chseqr_(job: *const c_char, compz: *const c_char, n: *const c_int, ilo: *const c_int,
                   ihi: *const c_int, h: *mut c_float_complex, ldh: *const c_int,
                   w: *mut c_float_complex, z: *mut c_float_complex, ldz: *const c_int,
                   work: *mut c_float_complex, lwork: *const c_int, info: *mut c_int);
    pub fn zhseqr_(job: *const c_char, compz: *const c_char, n: *const c_int, ilo: *const c_int,
                   ihi: *const c_int, h: *mut c_double_complex, ldh: *const c_int,
                   w: *mut c_double_complex, z: *mut c_double_complex, ldz: *const c_int,
                   work: *mut c_double_complex, lwork: *const c_int, info: *mut c_int);
    ...
    pub fn chsein_(side: *const c_char, eigsrc: *const c_char, initv: *const c_char,
                   select: *const c_int, n: *const c_int, h: *const c_float_complex,
                   ldh: *const c_int, w: *mut c_float_complex, vl: *mut c_float_complex,
                   ldvl: *const c_int, vr: *mut c_float_complex, ldvr: *const c_int,
                   mm: *const c_int, m: *mut c_int, work: *mut c_float_complex,
                   rwork: *mut c_float, ifaill: *mut c_int, ifailr: *mut c_int, info: *mut c_int);
    pub fn zhsein_(side: *const c_char, eigsrc: *const c_char, initv: *const c_char,
                   select: *const c_int, n: *const c_int, h: *const c_double_complex,
                   ldh: *const c_int, w: *mut c_double_complex, vl: *mut c_double_complex,
                   ldvl: *const c_int, vr: *mut c_double_complex, ldvr: *const c_int,
                   mm: *const c_int, m: *mut c_int, work: *mut c_double_complex,
    ...
    pub fn ctrevc_(side: *const c_char, howmny: *const c_char, select: *const c_int,
                   n: *const c_int, t: *mut c_float_complex, ldt: *const c_int,
                   vl: *mut c_float_complex, ldvl: *const c_int, vr: *mut c_float_complex,
                   ldvr: *const c_int, mm: *const c_int, m: *mut c_int, work: *mut c_float_complex,
                   rwork: *mut c_float, info: *mut c_int);
    pub fn ztrevc_(side: *const c_char, howmny: *const c_char, select: *const c_int,
                   n: *const c_int, t: *mut c_double_complex, ldt: *const c_int,
                   vl: *mut c_double_complex, ldvl: *const c_int, vr: *mut c_double_complex,
    ...
    pub fn ctrsna_(job: *const c_char, howmny: *const c_char, select: *const c_int,
                   n: *const c_int, t: *const c_float_complex, ldt: *const c_int,
                   vl: *const c_float_complex, ldvl: *const c_int, vr: *const c_float_complex,
                   ldvr: *const c_int, s: *mut c_float, sep: *mut c_float, mm: *const c_int,
                   m: *mut c_int, work: *mut c_float_complex, ldwork: *const c_int,
                   rwork: *mut c_float, info: *mut c_int);
    pub fn ztrsna_(job: *const c_char, howmny: *const c_char, select: *const c_int,
                   n: *const c_int, t: *const c_double_complex, ldt: *const c_int,
                   vl: *const c_double_complex, ldvl: *const c_int, vr: *const c_double_complex,
                   ldvr: *const c_int, s: *mut c_double, sep: *mut c_double, mm: *const c_int,
                   m: *mut c_int, work: *mut c_double_complex, ldwork: *const c_int,
                   rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn dtrexc_(compq: *const c_char, n: *const c_int, t: *mut c_double, ldt: *const c_int,
                   ...
                   work: *mut c_double, info: *mut c_int);
    pub fn ctrexc_(compq: *const c_char, n: *const c_int, t: *mut c_float_complex,
                   ldt: *const c_int, q: *mut c_float_complex, ldq: *const c_int,
                   ifst: *const c_int, ilst: *const c_int, info: *mut c_int);
    pub fn ztrexc_(compq: *const c_char, n: *const c_int, t: *mut c_double_complex,
                   ldt: *const c_int, q: *mut c_double_complex, ldq: *const c_int,
                   ifst: *const c_int, ilst: *const c_int, info: *mut c_int);
    ...
    pub fn ctrsen_(job: *const c_char, compq: *const c_char, select: *const c_int, n: *const c_int,
                   t: *mut c_float_complex, ldt: *const c_int, q: *mut c_float_complex,
                   ldq: *const c_int, w: *mut c_float_complex, m: *mut c_int, s: *mut c_float,
                   sep: *mut c_float, work: *mut c_float_complex, lwork: *const c_int,
                   info: *mut c_int);
    pub fn ztrsen_(job: *const c_char, compq: *const c_char, select: *const c_int, n: *const c_int,
                   t: *mut c_double_complex, ldt: *const c_int, q: *mut c_double_complex,
                   ldq: *const c_int, w: *mut c_double_complex, m: *mut c_int, s: *mut c_double,
                   sep: *mut c_double, work: *mut c_double_complex, lwork: *const c_int,
                   info: *mut c_int);
    ...
    pub fn ctrsyl_(trana: *const c_char, tranb: *const c_char, isgn: *const c_int, m: *const c_int,
                   n: *const c_int, a: *const c_float_complex, lda: *const c_int,
                   b: *const c_float_complex, ldb: *const c_int, c: *mut c_float_complex,
    ...
    pub fn ztrsyl_(trana: *const c_char, tranb: *const c_char, isgn: *const c_int, m: *const c_int,
                   n: *const c_int, a: *const c_double_complex, lda: *const c_int,
                   b: *const c_double_complex, ldb: *const c_int, c: *mut c_double_complex,
    ...
    pub fn cggbak_(job: *const c_char, side: *const c_char, n: *const c_int, ilo: *const c_int,
                   ihi: *const c_int, lscale: *const c_float, rscale: *const c_float,
                   m: *const c_int, v: *mut c_float_complex, ldv: *const c_int, info: *mut c_int);
    pub fn zggbak_(job: *const c_char, side: *const c_char, n: *const c_int, ilo: *const c_int,
                   ihi: *const c_int, lscale: *const c_double, rscale: *const c_double,
                   m: *const c_int, v: *mut c_double_complex, ldv: *const c_int, info: *mut c_int);
    ...
    pub fn chgeqz_(job: *const c_char, compq: *const c_char, compz: *const c_char, n: *const c_int,
                   ilo: *const c_int, ihi: *const c_int, h: *mut c_float_complex,
                   ldh: *const c_int, t: *mut c_float_complex, ldt: *const c_int,
                   alpha: *mut c_float_complex, beta: *mut c_float_complex,
                   q: *mut c_float_complex, ldq: *const c_int, z: *mut c_float_complex,
                   ldz: *const c_int, work: *mut c_float_complex, lwork: *const c_int,
                   rwork: *mut c_float, info: *mut c_int);
    pub fn zhgeqz_(job: *const c_char, compq: *const c_char, compz: *const c_char, n: *const c_int,
                   ilo: *const c_int, ihi: *const c_int, h: *mut c_double_complex,
                   ldh: *const c_int, t: *mut c_double_complex, ldt: *const c_int,
                   alpha: *mut c_double_complex, beta: *mut c_double_complex,
                   q: *mut c_double_complex, ldq: *const c_int, z: *mut c_double_complex,
                   ldz: *const c_int, work: *mut c_double_complex, lwork: *const c_int,
                   rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn ctgevc_(side: *const c_char, howmny: *const c_char, select: *const c_int,
                   n: *const c_int, s: *const c_float_complex, lds: *const c_int,
                   p: *const c_float_complex, ldp: *const c_int, vl: *mut c_float_complex,
                   ldvl: *const c_int, vr: *mut c_float_complex, ldvr: *const c_int,
                   mm: *const c_int, m: *mut c_int, work: *mut c_float_complex,
                   rwork: *mut c_float, info: *mut c_int);
    pub fn ztgevc_(side: *const c_char, howmny: *const c_char, select: *const c_int,
                   n: *const c_int, s: *const c_double_complex, lds: *const c_int,
                   p: *const c_double_complex, ldp: *const c_int, vl: *mut c_double_complex,
                   ldvl: *const c_int, vr: *mut c_double_complex, ldvr: *const c_int,
                   mm: *const c_int, m: *mut c_int, work: *mut c_double_complex,
                   rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn ctgexc_(wantq: *const c_int, wantz: *const c_int, n: *const c_int,
                   a: *mut c_float_complex, lda: *const c_int, b: *mut c_float_complex,
                   ldb: *const c_int, q: *mut c_float_complex, ldq: *const c_int,
                   z: *mut c_float_complex, ldz: *const c_int, ifst: *const c_int,
                   ilst: *mut c_int, info: *mut c_int);
    pub fn ztgexc_(wantq: *const c_int, wantz: *const c_int, n: *const c_int,
                   a: *mut c_double_complex, lda: *const c_int, b: *mut c_double_complex,
                   ldb: *const c_int, q: *mut c_double_complex, ldq: *const c_int,
                   z: *mut c_double_complex, ldz: *const c_int, ifst: *const c_int,
                   ilst: *mut c_int, info: *mut c_int);
    ...
    pub fn ctgsen_(ijob: *const c_int, wantq: *const c_int, wantz: *const c_int,
                   select: *const c_int, n: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, b: *mut c_float_complex, ldb: *const c_int,
                   alpha: *mut c_float_complex, beta: *mut c_float_complex,
                   q: *mut c_float_complex, ldq: *const c_int, z: *mut c_float_complex,
                   ldz: *const c_int, m: *mut c_int, pl: *mut c_float, pr: *mut c_float,
                   dif: *mut c_float, work: *mut c_float_complex, lwork: *const c_int,
                   iwork: *mut c_int, liwork: *const c_int, info: *mut c_int);
    pub fn ztgsen_(ijob: *const c_int, wantq: *const c_int, wantz: *const c_int,
                   select: *const c_int, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, b: *mut c_double_complex, ldb: *const c_int,
                   alpha: *mut c_double_complex, beta: *mut c_double_complex,
                   q: *mut c_double_complex, ldq: *const c_int, z: *mut c_double_complex,
                   ldz: *const c_int, m: *mut c_int, pl: *mut c_double, pr: *mut c_double,
                   dif: *mut c_double, work: *mut c_double_complex, lwork: *const c_int,
                   iwork: *mut c_int, liwork: *const c_int, info: *mut c_int);
    ...
    pub fn ctgsyl_(trans: *const c_char, ijob: *const c_int, m: *const c_int, n: *const c_int,
                   a: *const c_float_complex, lda: *const c_int, b: *const c_float_complex,
                   ldb: *const c_int, c: *mut c_float_complex, ldc: *const c_int,
                   d: *const c_float_complex, ldd: *const c_int, e: *const c_float_complex,
                   lde: *const c_int, f: *mut c_float_complex, ldf: *const c_int,
    ...
    pub fn ztgsyl_(trans: *const c_char, ijob: *const c_int, m: *const c_int, n: *const c_int,
                   a: *const c_double_complex, lda: *const c_int, b: *const c_double_complex,
                   ldb: *const c_int, c: *mut c_double_complex, ldc: *const c_int,
                   d: *const c_double_complex, ldd: *const c_int, e: *const c_double_complex,
                   lde: *const c_int, f: *mut c_double_complex, ldf: *const c_int,
    ...
    pub fn ctgsna_(job: *const c_char, howmny: *const c_char, select: *const c_int,
                   n: *const c_int, a: *const c_float_complex, lda: *const c_int,
                   b: *const c_float_complex, ldb: *const c_int, vl: *const c_float_complex,
                   ldvl: *const c_int, vr: *const c_float_complex, ldvr: *const c_int,
                   s: *mut c_float, dif: *mut c_float, mm: *const c_int, m: *mut c_int,
                   work: *mut c_float_complex, lwork: *const c_int, iwork: *mut c_int,
                   info: *mut c_int);
    pub fn ztgsna_(job: *const c_char, howmny: *const c_char, select: *const c_int,
                   n: *const c_int, a: *const c_double_complex, lda: *const c_int,
                   b: *const c_double_complex, ldb: *const c_int, vl: *const c_double_complex,
                   ldvl: *const c_int, vr: *const c_double_complex, ldvr: *const c_int,
                   s: *mut c_double, dif: *mut c_double, mm: *const c_int, m: *mut c_int,
                   work: *mut c_double_complex, lwork: *const c_int, iwork: *mut c_int,
                   info: *mut c_int);
    ...
    pub fn cggsvp_(jobu: *const c_char, jobv: *const c_char, jobq: *const c_char, m: *const c_int,
                   p: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                   b: *mut c_float_complex, ldb: *const c_int, tola: *const c_float,
                   tolb: *const c_float, k: *mut c_int, l: *mut c_int, u: *mut c_float_complex,
                   ldu: *const c_int, v: *mut c_float_complex, ldv: *const c_int,
                   q: *mut c_float_complex, ldq: *const c_int, iwork: *mut c_int,
                   rwork: *mut c_float, tau: *mut c_float_complex, work: *mut c_float_complex,
                   info: *mut c_int);
    pub fn zggsvp_(jobu: *const c_char, jobv: *const c_char, jobq: *const c_char, m: *const c_int,
                   p: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                   b: *mut c_double_complex, ldb: *const c_int, tola: *const c_double,
                   tolb: *const c_double, k: *mut c_int, l: *mut c_int, u: *mut c_double_complex,
                   ldu: *const c_int, v: *mut c_double_complex, ldv: *const c_int,
                   q: *mut c_double_complex, ldq: *const c_int, iwork: *mut c_int,
                   rwork: *mut c_double, tau: *mut c_double_complex, work: *mut c_double_complex,
                   info: *mut c_int);
    ...
    pub fn ztgsja_(jobu: *const c_char, jobv: *const c_char, jobq: *const c_char, m: *const c_int,
                   ...
                   ldu: *const c_int, v: *mut c_double_complex, ldv: *const c_int,
                   q: *mut c_double_complex, ldq: *const c_int, work: *mut c_double_complex,
                   ncycle: *mut c_int, info: *mut c_int);
    ...
    pub fn cgels_(trans: *const c_char, m: *const c_int, n: *const c_int, nrhs: *const c_int,
                  a: *mut c_float_complex, lda: *const c_int, b: *mut c_float_complex,
                  ldb: *const c_int, work: *mut c_float_complex, lwork: *const c_int,
                  info: *mut c_int);
    pub fn zgels_(trans: *const c_char, m: *const c_int, n: *const c_int, nrhs: *const c_int,
                  a: *mut c_double_complex, lda: *const c_int, b: *mut c_double_complex,
                  ldb: *const c_int, work: *mut c_double_complex, lwork: *const c_int,
                  info: *mut c_int);
    ...
    pub fn dgelsy_(m: *const c_int, n: *const c_int, nrhs: *const c_int, a: *mut c_double,
                   ...
                   lwork: *const c_int, info: *mut c_int);
    pub fn cgelsy_(m: *const c_int, n: *const c_int, nrhs: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, b: *mut c_float_complex, ldb: *const c_int, jpvt: *mut c_int,
                   rcond: *const c_float, rank: *mut c_int, work: *mut c_float_complex,
                   lwork: *const c_int, rwork: *mut c_float, info: *mut c_int);
    pub fn zgelsy_(m: *const c_int, n: *const c_int, nrhs: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, b: *mut c_double_complex, ldb: *const c_int,
                   jpvt: *mut c_int, rcond: *const c_double, rank: *mut c_int,
                   work: *mut c_double_complex, lwork: *const c_int, rwork: *mut c_double,
                   info: *mut c_int);
    ...
    pub fn dgelss_(m: *const c_int, n: *const c_int, nrhs: *const c_int, a: *mut c_double,
                   ...
                   rcond: *const c_double, rank: *mut c_int, work: *mut c_double,
                   lwork: *const c_int, info: *mut c_int);
    pub fn cgelss_(m: *const c_int, n: *const c_int, nrhs: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, b: *mut c_float_complex, ldb: *const c_int, s: *mut c_float,
                   rcond: *const c_float, rank: *mut c_int, work: *mut c_float_complex,
                   lwork: *const c_int, rwork: *mut c_float, info: *mut c_int);
    pub fn zgelss_(m: *const c_int, n: *const c_int, nrhs: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, b: *mut c_double_complex, ldb: *const c_int,
                   s: *mut c_double, rcond: *const c_double, rank: *mut c_int,
                   work: *mut c_double_complex, lwork: *const c_int, rwork: *mut c_double,
                   info: *mut c_int);
    ...
    pub fn dgelsd_(m: *const c_int, n: *const c_int, nrhs: *const c_int, a: *const c_double,
                   ...
                   rcond: *const c_double, rank: *mut c_int, work: *mut c_double,
                   lwork: *const c_int, iwork: *mut c_int, info: *mut c_int);
    pub fn cgelsd_(m: *const c_int, n: *const c_int, nrhs: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, b: *mut c_float_complex, ldb: *const c_int, s: *mut c_float,
                   rcond: *const c_float, rank: *mut c_int, work: *mut c_float_complex,
    ...
    pub fn zgelsd_(m: *const c_int, n: *const c_int, nrhs: *const c_int,
                   a: *const c_double_complex, lda: *const c_int, b: *mut c_double_complex,
                   ldb: *const c_int, s: *mut c_double, rcond: *const c_double, rank: *mut c_int,
                   work: *mut c_double_complex, lwork: *const c_int, rwork: *mut c_double,
                   iwork: *mut c_int, info: *mut c_int);
    ...
    pub fn dgglse_(m: *const c_int, n: *const c_int, p: *const c_int, a: *mut c_double,
                   ...
                   info: *mut c_int);
    pub fn cgglse_(m: *const c_int, n: *const c_int, p: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, b: *mut c_float_complex, ldb: *const c_int,
                   c: *mut c_float_complex, d: *mut c_float_complex, x: *mut c_float_complex,
                   work: *mut c_float_complex, lwork: *const c_int, info: *mut c_int);
    pub fn zgglse_(m: *const c_int, n: *const c_int, p: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, b: *mut c_double_complex, ldb: *const c_int,
                   c: *mut c_double_complex, d: *mut c_double_complex, x: *mut c_double_complex,
                   work: *mut c_double_complex, lwork: *const c_int, info: *mut c_int);
    ...
    pub fn dggglm_(n: *const c_int, m: *const c_int, p: *const c_int, a: *mut c_double,
                   ...
                   info: *mut c_int);
    pub fn cggglm_(n: *const c_int, m: *const c_int, p: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, b: *mut c_float_complex, ldb: *const c_int,
                   d: *mut c_float_complex, x: *mut c_float_complex, y: *mut c_float_complex,
                   work: *mut c_float_complex, lwork: *const c_int, info: *mut c_int);
    pub fn zggglm_(n: *const c_int, m: *const c_int, p: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, b: *mut c_double_complex, ldb: *const c_int,
                   d: *mut c_double_complex, x: *mut c_double_complex, y: *mut c_double_complex,
                   work: *mut c_double_complex, lwork: *const c_int, info: *mut c_int);
    ...
    pub fn cheevx_(jobz: *const c_char, range: *const c_char, uplo: *const c_char, n: *const c_int,
                   a: *mut c_float_complex, lda: *const c_int, vl: *const c_float,
                   vu: *const c_float, il: *const c_int, iu: *const c_int, abstol: *const c_float,
                   m: *mut c_int, w: *mut c_float, z: *mut c_float_complex, ldz: *const c_int,
                   work: *mut c_float_complex, lwork: *const c_int, rwork: *mut c_float,
                   iwork: *mut c_int, ifail: *mut c_int, info: *mut c_int);
    pub fn zheevx_(jobz: *const c_char, range: *const c_char, uplo: *const c_char, n: *const c_int,
                   a: *mut c_double_complex, lda: *const c_int, vl: *const c_double,
    ...
    pub fn cheevr_(jobz: *const c_char, range: *const c_char, uplo: *const c_char, n: *const c_int,
                   ...
                   vu: *const c_float, il: *const c_int, iu: *const c_int, abstol: *const c_float,
                   m: *mut c_int, w: *mut c_float, z: *mut c_float_complex, ldz: *const c_int,
                   isuppz: *mut c_int, work: *mut c_float_complex, lwork: *const c_int,
    ...
    pub fn chpev_(jobz: *const c_char, uplo: *const c_char, n: *const c_int,
                  ...
                  ldz: *const c_int, work: *mut c_float_complex, rwork: *mut c_float,
                  info: *mut c_int);
    pub fn zhpev_(jobz: *const c_char, uplo: *const c_char, n: *const c_int,
                  ...
                  ldz: *const c_int, work: *mut c_double_complex, rwork: *mut c_double,
                  info: *mut c_int);
    ...
    pub fn chpevx_(jobz: *const c_char, range: *const c_char, uplo: *const c_char, n: *const c_int,
                   ap: *mut c_float_complex, vl: *const c_float, vu: *const c_float,
                   il: *const c_int, iu: *const c_int, abstol: *const c_float, m: *mut c_int,
                   w: *mut c_float, z: *mut c_float_complex, ldz: *const c_int,
    ...
    pub fn zhpevx_(jobz: *const c_char, range: *const c_char, uplo: *const c_char, n: *const c_int,
                   ap: *mut c_double_complex, vl: *const c_double, vu: *const c_double,
                   il: *const c_int, iu: *const c_int, abstol: *const c_double, m: *mut c_int,
                   w: *mut c_double, z: *mut c_double_complex, ldz: *const c_int,
    ...
    pub fn chbev_(jobz: *const c_char, uplo: *const c_char, n: *const c_int, kd: *const c_int,
                  ab: *mut c_float_complex, ldab: *const c_int, w: *mut c_float,
                  z: *mut c_float_complex, ldz: *const c_int, work: *mut c_float_complex,
                  rwork: *mut c_float, info: *mut c_int);
    pub fn zhbev_(jobz: *const c_char, uplo: *const c_char, n: *const c_int, kd: *const c_int,
                  ab: *mut c_double_complex, ldab: *const c_int, w: *mut c_double,
                  z: *mut c_double_complex, ldz: *const c_int, work: *mut c_double_complex,
                  rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn chbevx_(jobz: *const c_char, range: *const c_char, uplo: *const c_char, n: *const c_int,
                   kd: *const c_int, ab: *mut c_float_complex, ldab: *const c_int,
                   q: *mut c_float_complex, ldq: *const c_int, vl: *const c_float,
                   vu: *const c_float, il: *const c_int, iu: *const c_int, abstol: *const c_float,
                   m: *mut c_int, w: *mut c_float, z: *mut c_float_complex, ldz: *const c_int,
                   work: *mut c_float_complex, rwork: *mut c_float, iwork: *mut c_int,
                   ifail: *mut c_int, info: *mut c_int);
    pub fn zhbevx_(jobz: *const c_char, range: *const c_char, uplo: *const c_char, n: *const c_int,
                   kd: *const c_int, ab: *mut c_double_complex, ldab: *const c_int,
                   q: *mut c_double_complex, ldq: *const c_int, vl: *const c_double,
                   vu: *const c_double, il: *const c_int, iu: *const c_int,
                   abstol: *const c_double, m: *mut c_int, w: *mut c_double,
                   z: *mut c_double_complex, ldz: *const c_int, work: *mut c_double_complex,
    ...
    pub fn cgees_(jobvs: *const c_char, sort: *const c_char, select: LAPACK_C_SELECT1,
                  n: *const c_int, a: *mut c_float_complex, lda: *const c_int, sdim: *mut c_int,
                  w: *mut c_float_complex, vs: *mut c_float_complex, ldvs: *const c_int,
                  work: *mut c_float_complex, lwork: *const c_int, rwork: *mut c_float,
                  bwork: *mut c_int, info: *mut c_int);
    pub fn zgees_(jobvs: *const c_char, sort: *const c_char, select: LAPACK_Z_SELECT1,
                  n: *const c_int, a: *mut c_double_complex, lda: *const c_int, sdim: *mut c_int,
                  w: *mut c_double_complex, vs: *mut c_double_complex, ldvs: *const c_int,
                  work: *mut c_double_complex, lwork: *const c_int, rwork: *mut c_double,
                  bwork: *mut c_int, info: *mut c_int);
    ...
    pub fn cgeesx_(jobvs: *const c_char, sort: *const c_char, select: LAPACK_C_SELECT1,
                   sense: *const c_char, n: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, sdim: *mut c_int, w: *mut c_float_complex,
                   vs: *mut c_float_complex, ldvs: *const c_int, rconde: *mut c_float,
                   rcondv: *mut c_float, work: *mut c_float_complex, lwork: *const c_int,
    ...
    pub fn zgeesx_(jobvs: *const c_char, sort: *const c_char, select: LAPACK_Z_SELECT1,
                   sense: *const c_char, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, sdim: *mut c_int, w: *mut c_double_complex,
                   vs: *mut c_double_complex, ldvs: *const c_int, rconde: *mut c_double,
                   rcondv: *mut c_double, work: *mut c_double_complex, lwork: *const c_int,
    ...
    pub fn cgeev_(jobvl: *const c_char, jobvr: *const c_char, n: *const c_int,
                  a: *mut c_float_complex, lda: *const c_int, w: *mut c_float_complex,
                  vl: *mut c_float_complex, ldvl: *const c_int, vr: *mut c_float_complex,
                  ldvr: *const c_int, work: *mut c_float_complex, lwork: *const c_int,
                  rwork: *mut c_float, info: *mut c_int);
    pub fn zgeev_(jobvl: *const c_char, jobvr: *const c_char, n: *const c_int,
                  a: *mut c_double_complex, lda: *const c_int, w: *mut c_double_complex,
                  vl: *mut c_double_complex, ldvl: *const c_int, vr: *mut c_double_complex,
                  ldvr: *const c_int, work: *mut c_double_complex, lwork: *const c_int,
                  rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn cgeevx_(balanc: *const c_char, jobvl: *const c_char, jobvr: *const c_char,
                   sense: *const c_char, n: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, w: *mut c_float_complex, vl: *mut c_float_complex,
                   ldvl: *const c_int, vr: *mut c_float_complex, ldvr: *const c_int,
    ...
    pub fn zgeevx_(balanc: *const c_char, jobvl: *const c_char, jobvr: *const c_char,
                   sense: *const c_char, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, w: *mut c_double_complex, vl: *mut c_double_complex,
                   ldvl: *const c_int, vr: *mut c_double_complex, ldvr: *const c_int,
    ...
    pub fn cgesvd_(jobu: *const c_char, jobvt: *const c_char, m: *const c_int, n: *const c_int,
                   a: *mut c_float_complex, lda: *const c_int, s: *mut c_float,
                   u: *mut c_float_complex, ldu: *const c_int, vt: *mut c_float_complex,
                   ldvt: *const c_int, work: *mut c_float_complex, lwork: *const c_int,
                   rwork: *mut c_float, info: *mut c_int);
    pub fn zgesvd_(jobu: *const c_char, jobvt: *const c_char, m: *const c_int, n: *const c_int,
                   a: *mut c_double_complex, lda: *const c_int, s: *mut c_double,
                   u: *mut c_double_complex, ldu: *const c_int, vt: *mut c_double_complex,
                   ldvt: *const c_int, work: *mut c_double_complex, lwork: *const c_int,
                   rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn dgesdd_(jobz: *const c_char, m: *const c_int, n: *const c_int, a: *mut c_double,
                   ...
                   iwork: *mut c_int, info: *mut c_int);
    pub fn cgesdd_(jobz: *const c_char, m: *const c_int, n: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, s: *mut c_float, u: *mut c_float_complex, ldu: *const c_int,
                   vt: *mut c_float_complex, ldvt: *const c_int, work: *mut c_float_complex,
                   lwork: *const c_int, rwork: *mut c_float, iwork: *mut c_int, info: *mut c_int);
    pub fn zgesdd_(jobz: *const c_char, m: *const c_int, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, s: *mut c_double, u: *mut c_double_complex,
                   ldu: *const c_int, vt: *mut c_double_complex, ldvt: *const c_int,
                   work: *mut c_double_complex, lwork: *const c_int, rwork: *mut c_double,
                   iwork: *mut c_int, info: *mut c_int);
    ...
    pub fn cggsvd_(jobu: *const c_char, jobv: *const c_char, jobq: *const c_char, m: *const c_int,
                   ...
                   u: *mut c_float_complex, ldu: *const c_int, v: *mut c_float_complex,
                   ldv: *const c_int, q: *mut c_float_complex, ldq: *const c_int,
                   work: *mut c_float_complex, rwork: *mut c_float, iwork: *mut c_int,
                   info: *mut c_int);
    pub fn zggsvd_(jobu: *const c_char, jobv: *const c_char, jobq: *const c_char, m: *const c_int,
                   ...
                   u: *mut c_double_complex, ldu: *const c_int, v: *mut c_double_complex,
                   ldv: *const c_int, q: *mut c_double_complex, ldq: *const c_int,
                   work: *mut c_double_complex, rwork: *mut c_double, iwork: *mut c_int,
                   info: *mut c_int);
    ...
    pub fn chegv_(itype: *const c_int, jobz: *const c_char, uplo: *const c_char, n: *const c_int,
                  a: *mut c_float_complex, lda: *const c_int, b: *mut c_float_complex,
                  ldb: *const c_int, w: *mut c_float, work: *mut c_float_complex,
                  lwork: *const c_int, rwork: *mut c_float, info: *mut c_int);
    pub fn zhegv_(itype: *const c_int, jobz: *const c_char, uplo: *const c_char, n: *const c_int,
                  a: *mut c_double_complex, lda: *const c_int, b: *mut c_double_complex,
                  ldb: *const c_int, w: *mut c_double, work: *mut c_double_complex,
                  lwork: *const c_int, rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn chegvx_(itype: *const c_int, jobz: *const c_char, range: *const c_char,
                   uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, b: *mut c_float_complex, ldb: *const c_int,
                   vl: *const c_float, vu: *const c_float, il: *const c_int, iu: *const c_int,
                   abstol: *const c_float, m: *mut c_int, w: *mut c_float, z: *mut c_float_complex,
                   ldz: *const c_int, work: *mut c_float_complex, lwork: *const c_int,
    ...
    pub fn zhegvx_(itype: *const c_int, jobz: *const c_char, range: *const c_char,
                   uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, b: *mut c_double_complex, ldb: *const c_int,
                   vl: *const c_double, vu: *const c_double, il: *const c_int, iu: *const c_int,
                   abstol: *const c_double, m: *mut c_int, w: *mut c_double,
                   z: *mut c_double_complex, ldz: *const c_int, work: *mut c_double_complex,
    ...
    pub fn chpgvx_(itype: *const c_int, jobz: *const c_char, range: *const c_char,
                   uplo: *const c_char, n: *const c_int, ap: *mut c_float_complex,
                   bp: *mut c_float_complex, vl: *const c_float, vu: *const c_float,
                   il: *const c_int, iu: *const c_int, abstol: *const c_float, m: *mut c_int,
                   w: *mut c_float, z: *mut c_float_complex, ldz: *const c_int,
                   work: *mut c_float_complex, rwork: *mut c_float, iwork: *mut c_int,
                   ifail: *mut c_int, info: *mut c_int);
    pub fn zhpgvx_(itype: *const c_int, jobz: *const c_char, range: *const c_char,
                   uplo: *const c_char, n: *const c_int, ap: *mut c_double_complex,
                   bp: *mut c_double_complex, vl: *const c_double, vu: *const c_double,
                   il: *const c_int, iu: *const c_int, abstol: *const c_double, m: *mut c_int,
                   w: *mut c_double, z: *mut c_double_complex, ldz: *const c_int,
                   work: *mut c_double_complex, rwork: *mut c_double, iwork: *mut c_int,
                   ifail: *mut c_int, info: *mut c_int);
    ...
    pub fn chbgv_(jobz: *const c_char, uplo: *const c_char, n: *const c_int, ka: *const c_int,
                  kb: *const c_int, ab: *mut c_float_complex, ldab: *const c_int,
                  bb: *mut c_float_complex, ldbb: *const c_int, w: *mut c_float,
                  z: *mut c_float_complex, ldz: *const c_int, work: *mut c_float_complex,
                  rwork: *mut c_float, info: *mut c_int);
    pub fn zhbgv_(jobz: *const c_char, uplo: *const c_char, n: *const c_int, ka: *const c_int,
                  kb: *const c_int, ab: *mut c_double_complex, ldab: *const c_int,
                  bb: *mut c_double_complex, ldbb: *const c_int, w: *mut c_double,
                  z: *mut c_double_complex, ldz: *const c_int, work: *mut c_double_complex,
                  rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn chbgvx_(jobz: *const c_char, range: *const c_char, uplo: *const c_char, n: *const c_int,
                   ka: *const c_int, kb: *const c_int, ab: *mut c_float_complex,
                   ldab: *const c_int, bb: *mut c_float_complex, ldbb: *const c_int,
                   q: *mut c_float_complex, ldq: *const c_int, vl: *const c_float,
                   vu: *const c_float, il: *const c_int, iu: *const c_int, abstol: *const c_float,
                   m: *mut c_int, w: *mut c_float, z: *mut c_float_complex, ldz: *const c_int,
                   work: *mut c_float_complex, rwork: *mut c_float, iwork: *mut c_int,
    ...
    pub fn zhbgvx_(jobz: *const c_char, range: *const c_char, uplo: *const c_char, n: *const c_int,
                   ka: *const c_int, kb: *const c_int, ab: *mut c_double_complex,
                   ldab: *const c_int, bb: *mut c_double_complex, ldbb: *const c_int,
                   q: *mut c_double_complex, ldq: *const c_int, vl: *const c_double,
                   vu: *const c_double, il: *const c_int, iu: *const c_int,
                   abstol: *const c_double, m: *mut c_int, w: *mut c_double,
                   z: *mut c_double_complex, ldz: *const c_int, work: *mut c_double_complex,
    ...
    pub fn sgges_(jobvsl: *const c_char, jobvsr: *const c_char, sort: *const c_char,
                  selctg: LAPACK_S_SELECT3, n: *const c_int, a: *mut c_float, lda: *const c_int,
    ...
    pub fn dgges_(jobvsl: *const c_char, jobvsr: *const c_char, sort: *const c_char,
                  selctg: LAPACK_D_SELECT3, n: *const c_int, a: *mut c_double, lda: *const c_int,
    ...
    pub fn cgges_(jobvsl: *const c_char, jobvsr: *const c_char, sort: *const c_char,
                  selctg: LAPACK_C_SELECT2, n: *const c_int, a: *mut c_float_complex,
                  lda: *const c_int, b: *mut c_float_complex, ldb: *const c_int, sdim: *mut c_int,
                  alpha: *mut c_float_complex, beta: *mut c_float_complex,
                  vsl: *mut c_float_complex, ldvsl: *const c_int, vsr: *mut c_float_complex,
                  ldvsr: *const c_int, work: *mut c_float_complex, lwork: *const c_int,
                  rwork: *mut c_float, bwork: *mut c_int, info: *mut c_int);
    pub fn zgges_(jobvsl: *const c_char, jobvsr: *const c_char, sort: *const c_char,
                  selctg: LAPACK_Z_SELECT2, n: *const c_int, a: *mut c_double_complex,
                  lda: *const c_int, b: *mut c_double_complex, ldb: *const c_int, sdim: *mut c_int,
                  alpha: *mut c_double_complex, beta: *mut c_double_complex,
                  vsl: *mut c_double_complex, ldvsl: *const c_int, vsr: *mut c_double_complex,
                  ldvsr: *const c_int, work: *mut c_double_complex, lwork: *const c_int,
                  rwork: *mut c_double, bwork: *mut c_int, info: *mut c_int);

    pub fn sggesx_(jobvsl: *const c_char, jobvsr: *const c_char, sort: *const c_char,
                   selctg: LAPACK_S_SELECT3, sense: *const c_char, n: *const c_int,
                   a: *mut c_float, lda: *const c_int, b: *mut c_float, ldb: *const c_int,
                   sdim: *mut c_int, alphar: *mut c_float, alphai: *mut c_float,
                   beta: *mut c_float, vsl: *mut c_float, ldvsl: *const c_int, vsr: *mut c_float,
                   ldvsr: *const c_int, rconde: *mut c_float, rcondv: *mut c_float,
                   work: *mut c_float, lwork: *const c_int, iwork: *mut c_int,
                   liwork: *const c_int, bwork: *mut c_int, info: *mut c_int);
    pub fn dggesx_(jobvsl: *const c_char, jobvsr: *const c_char, sort: *const c_char,
                   selctg: LAPACK_D_SELECT3, sense: *const c_char, n: *const c_int,
                   a: *mut c_double, lda: *const c_int, b: *mut c_double, ldb: *const c_int,
                   sdim: *mut c_int, alphar: *mut c_double, alphai: *mut c_double,
                   beta: *mut c_double, vsl: *mut c_double, ldvsl: *const c_int,
                   vsr: *mut c_double, ldvsr: *const c_int, rconde: *mut c_double,
                   rcondv: *mut c_double, work: *mut c_double, lwork: *const c_int,
                   iwork: *mut c_int, liwork: *const c_int, bwork: *mut c_int, info: *mut c_int);
    pub fn cggesx_(jobvsl: *const c_char, jobvsr: *const c_char, sort: *const c_char,
                   selctg: LAPACK_C_SELECT2, sense: *const c_char, n: *const c_int,
                   a: *mut c_float_complex, lda: *const c_int, b: *mut c_float_complex,
                   ldb: *const c_int, sdim: *mut c_int, alpha: *mut c_float_complex,
                   beta: *mut c_float_complex, vsl: *mut c_float_complex, ldvsl: *const c_int,
                   vsr: *mut c_float_complex, ldvsr: *const c_int, rconde: *mut c_float,
                   rcondv: *mut c_float, work: *mut c_float_complex, lwork: *const c_int,
                   rwork: *mut c_float, iwork: *mut c_int, liwork: *const c_int, bwork: *mut c_int,
                   info: *mut c_int);
    pub fn zggesx_(jobvsl: *const c_char, jobvsr: *const c_char, sort: *const c_char,
                   selctg: LAPACK_Z_SELECT2, sense: *const c_char, n: *const c_int,
                   a: *mut c_double_complex, lda: *const c_int, b: *mut c_double_complex,
                   ldb: *const c_int, sdim: *mut c_int, alpha: *mut c_double_complex,
                   beta: *mut c_double_complex, vsl: *mut c_double_complex, ldvsl: *const c_int,
                   vsr: *mut c_double_complex, ldvsr: *const c_int, rconde: *mut c_double,
                   rcondv: *mut c_double, work: *mut c_double_complex, lwork: *const c_int,
                   rwork: *mut c_double, iwork: *mut c_int, liwork: *const c_int,
                   bwork: *mut c_int, info: *mut c_int);
    ...
    pub fn cggev_(jobvl: *const c_char, jobvr: *const c_char, n: *const c_int,
                  a: *mut c_float_complex, lda: *const c_int, b: *mut c_float_complex,
                  ldb: *const c_int, alpha: *mut c_float_complex, beta: *mut c_float_complex,
                  vl: *mut c_float_complex, ldvl: *const c_int, vr: *mut c_float_complex,
                  ldvr: *const c_int, work: *mut c_float_complex, lwork: *const c_int,
                  rwork: *mut c_float, info: *mut c_int);
    pub fn zggev_(jobvl: *const c_char, jobvr: *const c_char, n: *const c_int,
                  a: *mut c_double_complex, lda: *const c_int, b: *mut c_double_complex,
                  ldb: *const c_int, alpha: *mut c_double_complex, beta: *mut c_double_complex,
                  vl: *mut c_double_complex, ldvl: *const c_int, vr: *mut c_double_complex,
                  ldvr: *const c_int, work: *mut c_double_complex, lwork: *const c_int,
                  rwork: *mut c_double, info: *mut c_int);
    ...
    pub fn cggevx_(balanc: *const c_char, jobvl: *const c_char, jobvr: *const c_char,
                   ...
                   rscale: *mut c_float, abnrm: *mut c_float, bbnrm: *mut c_float,
                   rconde: *mut c_float, rcondv: *mut c_float, work: *mut c_float_complex,
                   lwork: *const c_int, rwork: *mut c_float, iwork: *mut c_int, bwork: *mut c_int,
                   info: *mut c_int);
    pub fn zggevx_(balanc: *const c_char, jobvl: *const c_char, jobvr: *const c_char,
                   ...
                   alpha: *mut c_double_complex, beta: *mut c_double_complex,
                   vl: *mut c_double_complex, ldvl: *const c_int, vr: *mut c_double_complex,
                   ldvr: *const c_int, ilo: *mut c_int, ihi: *mut c_int, lscale: *mut c_double,
                   rscale: *mut c_double, abnrm: *mut c_double, bbnrm: *mut c_double,
                   rconde: *mut c_double, rcondv: *mut c_double, work: *mut c_double_complex,
                   lwork: *const c_int, rwork: *mut c_double, iwork: *mut c_int, bwork: *mut c_int,
                   info: *mut c_int);
    ...
    pub fn chfrk_(transr: *const c_char, uplo: *const c_char, trans: *const c_char,
                  ...
                  a: *const c_float_complex, lda: *const c_int, beta: *const c_float,
    ...
    pub fn zhfrk_(transr: *const c_char, uplo: *const c_char, trans: *const c_char,
                  ...
                  a: *const c_double_complex, lda: *const c_int, beta: *const c_double,
    ...
    pub fn ztfttp_(transr: *const c_char, uplo: *const c_char, n: *const c_int,
                   arf: *const c_double_complex, ap: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn ctfttr_(transr: *const c_char, uplo: *const c_char, n: *const c_int,
                   arf: *const c_float_complex, a: *mut c_float_complex, lda: *const c_int,
                   info: *mut c_int);
    pub fn ztfttr_(transr: *const c_char, uplo: *const c_char, n: *const c_int,
                   arf: *const c_double_complex, a: *mut c_double_complex, lda: *const c_int,
                   info: *mut c_int);
    ...
    pub fn ztpttf_(transr: *const c_char, uplo: *const c_char, n: *const c_int,
                   ap: *const c_double_complex, arf: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn dtpttr_(uplo: *const c_char, n: *const c_int, ap: *const c_double, a: *mut c_double,
                   lda: *const c_int, info: *mut c_int);
    pub fn ctpttr_(uplo: *const c_char, n: *const c_int, ap: *const c_float_complex,
                   a: *mut c_float_complex, lda: *const c_int, info: *mut c_int);
    pub fn ztpttr_(uplo: *const c_char, n: *const c_int, ap: *const c_double_complex,
                   a: *mut c_double_complex, lda: *const c_int, info: *mut c_int);
    ...
    pub fn ctrttf_(transr: *const c_char, uplo: *const c_char, n: *const c_int,
                   a: *const c_float_complex, lda: *const c_int, arf: *mut c_float_complex,
                   info: *mut c_int);
    pub fn ztrttf_(transr: *const c_char, uplo: *const c_char, n: *const c_int,
                   a: *const c_double_complex, lda: *const c_int, arf: *mut c_double_complex,
                   info: *mut c_int);
    ...
    pub fn ctrttp_(uplo: *const c_char, n: *const c_int, a: *const c_float_complex,
                   lda: *const c_int, ap: *mut c_float_complex, info: *mut c_int);
    pub fn ztrttp_(uplo: *const c_char, n: *const c_int, a: *const c_double_complex,
                   lda: *const c_int, ap: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn cgeqrfp_(m: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                    tau: *mut c_float_complex, work: *mut c_float_complex, lwork: *const c_int,
                    info: *mut c_int);
    pub fn zgeqrfp_(m: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                    tau: *mut c_double_complex, work: *mut c_double_complex, lwork: *const c_int,
                    info: *mut c_int);

    pub fn clacgv_(n: *const c_int, x: *mut c_float_complex, incx: *const c_int);
    pub fn zlacgv_(n: *const c_int, x: *mut c_double_complex, incx: *const c_int);
    ...
    pub fn cgeqr2_(m: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                   tau: *mut c_float_complex, work: *mut c_float_complex, info: *mut c_int);
    pub fn zgeqr2_(m: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                   tau: *mut c_double_complex, work: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn clacn2_(n: *const c_int, v: *mut c_float_complex, x: *mut c_float_complex,
                   est: *mut c_float, kase: *mut c_int, isave: *mut c_int);
    pub fn zlacn2_(n: *const c_int, v: *mut c_double_complex, x: *mut c_double_complex,
                   est: *mut c_double, kase: *mut c_int, isave: *mut c_int);
    ...
    pub fn dgetf2_(m: *const c_int, n: *const c_int, a: *mut c_double, lda: *const c_int,
                   ipiv: *mut c_int, info: *mut c_int);
    pub fn cgetf2_(m: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                   ipiv: *mut c_int, info: *mut c_int);
    pub fn zgetf2_(m: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                   ipiv: *mut c_int, info: *mut c_int);
    ...
    pub fn dlaswp_(n: *const c_int, a: *mut c_double, lda: *const c_int, k1: *const c_int,
                   k2: *const c_int, ipiv: *const c_int, incx: *const c_int);
    pub fn claswp_(n: *const c_int, a: *mut c_float_complex, lda: *const c_int, k1: *const c_int,
                   k2: *const c_int, ipiv: *const c_int, incx: *const c_int);
    pub fn zlaswp_(n: *const c_int, a: *mut c_double_complex, lda: *const c_int, k1: *const c_int,
                   k2: *const c_int, ipiv: *const c_int, incx: *const c_int);
    ...
    pub fn dlantr_(norm: *const c_char, uplo: *const c_char, diag: *const c_char, m: *const c_int,
                   n: *const c_int, a: *const c_double, lda: *const c_int, work: *mut c_double)
                   -> c_double;
    ...
    pub fn dgelq2_(m: *const c_int, n: *const c_int, a: *mut c_double, lda: *const c_int,
                   tau: *mut c_double, work: *mut c_double, info: *mut c_int);
    pub fn cgelq2_(m: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                   tau: *mut c_float_complex, work: *mut c_float_complex, info: *mut c_int);
    pub fn zgelq2_(m: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                   tau: *mut c_double_complex, work: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn clarfb_(side: *const c_char, trans: *const c_char, direct: *const c_char,
                   storev: *const c_char, m: *const c_int, n: *const c_int, k: *const c_int,
                   v: *const c_float_complex, ldv: *const c_int, t: *const c_float_complex,
                   ldt: *const c_int, c: *mut c_float_complex, ldc: *const c_int,
                   work: *mut c_float_complex, ldwork: *const c_int);
    pub fn zlarfb_(side: *const c_char, trans: *const c_char, direct: *const c_char,
                   storev: *const c_char, m: *const c_int, n: *const c_int, k: *const c_int,
                   v: *const c_double_complex, ldv: *const c_int, t: *const c_double_complex,
                   ldt: *const c_int, c: *mut c_double_complex, ldc: *const c_int,
                   work: *mut c_double_complex, ldwork: *const c_int);
    ...
    pub fn dlarfg_(n: *const c_int, alpha: *mut c_double, x: *mut c_double, incx: *const c_int,
                   tau: *mut c_double);
    pub fn clarfg_(n: *const c_int, alpha: *mut c_float_complex, x: *mut c_float_complex,
                   incx: *const c_int, tau: *mut c_float_complex);
    pub fn zlarfg_(n: *const c_int, alpha: *mut c_double_complex, x: *mut c_double_complex,
                   incx: *const c_int, tau: *mut c_double_complex);
    ...
    pub fn clarft_(direct: *const c_char, storev: *const c_char, n: *const c_int, k: *const c_int,
                   v: *mut c_float_complex, ldv: *const c_int, tau: *const c_float_complex,
                   t: *mut c_float_complex, ldt: *const c_int);
    pub fn zlarft_(direct: *const c_char, storev: *const c_char, n: *const c_int, k: *const c_int,
                   v: *mut c_double_complex, ldv: *const c_int, tau: *const c_double_complex,
                   t: *mut c_double_complex, ldt: *const c_int);
    ...
    pub fn clarfx_(side: *const c_char, m: *const c_int, n: *const c_int,
                   v: *const c_float_complex, tau: *const c_float_complex, c: *mut c_float_complex,
                   ldc: *const c_int, work: *mut c_float_complex);
    pub fn zlarfx_(side: *const c_char, m: *const c_int, n: *const c_int,
                   v: *const c_double_complex, tau: *const c_double_complex,
                   c: *mut c_double_complex, ldc: *const c_int, work: *mut c_double_complex);
    ...
    pub fn clatms_(m: *const c_int, n: *const c_int, dist: *const c_char, iseed: *mut c_int,
                   sym: *const c_char, d: *mut c_float, mode: *const c_int, cond: *const c_float,
                   dmax: *const c_float, kl: *const c_int, ku: *const c_int, pack: *const c_char,
                   a: *mut c_float_complex, lda: *const c_int, work: *mut c_float_complex,
                   info: *mut c_int);
    pub fn zlatms_(m: *const c_int, n: *const c_int, dist: *const c_char, iseed: *mut c_int,
                   sym: *const c_char, d: *mut c_double, mode: *const c_int, cond: *const c_double,
                   dmax: *const c_double, kl: *const c_int, ku: *const c_int, pack: *const c_char,
                   a: *mut c_double_complex, lda: *const c_int, work: *mut c_double_complex,
                   info: *mut c_int);
    ...
    pub fn zlag2c_(m: *const c_int, n: *const c_int, a: *const c_double_complex, lda: *const c_int,
                   sa: *mut c_float_complex, ldsa: *const c_int, info: *mut c_int);

    pub fn clag2z_(m: *const c_int, n: *const c_int, sa: *const c_float_complex,
                   ldsa: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                   info: *mut c_int);
    ...
    pub fn dlauum_(uplo: *const c_char, n: *const c_int, a: *mut c_double, lda: *const c_int,
                   info: *mut c_int);
    pub fn clauum_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, info: *mut c_int);
    pub fn zlauum_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, info: *mut c_int);
    ...
    pub fn clagge_(m: *const c_int, n: *const c_int, kl: *const c_int, ku: *const c_int,
                   d: *const c_float, a: *mut c_float_complex, lda: *const c_int,
    ...
    pub fn zlagge_(m: *const c_int, n: *const c_int, kl: *const c_int, ku: *const c_int,
                   d: *const c_double, a: *mut c_double_complex, lda: *const c_int,
    ...
    pub fn claset_(uplo: *const c_char, m: *const c_int, n: *const c_int,
                   alpha: *const c_float_complex, beta: *const c_float_complex,
                   a: *mut c_float_complex, lda: *const c_int);
    pub fn zlaset_(uplo: *const c_char, m: *const c_int, n: *const c_int,
                   alpha: *const c_double_complex, beta: *const c_double_complex,
                   a: *mut c_double_complex, lda: *const c_int);
    ...
    pub fn claghe_(n: *const c_int, k: *const c_int, d: *const c_float, a: *mut c_float_complex,
                   lda: *const c_int, iseed: *mut c_int, work: *mut c_float_complex,
                   info: *mut c_int);
    pub fn zlaghe_(n: *const c_int, k: *const c_int, d: *const c_double, a: *mut c_double_complex,
                   lda: *const c_int, iseed: *mut c_int, work: *mut c_double_complex,
                   info: *mut c_int);
    ...
    pub fn clagsy_(n: *const c_int, k: *const c_int, d: *const c_float, a: *mut c_float_complex,
                   lda: *const c_int, iseed: *mut c_int, work: *mut c_float_complex,
                   info: *mut c_int);
    pub fn zlagsy_(n: *const c_int, k: *const c_int, d: *const c_double, a: *mut c_double_complex,
                   lda: *const c_int, iseed: *mut c_int, work: *mut c_double_complex,
                   info: *mut c_int);
    ...
    pub fn dlapmr_(forwrd: *const c_int, m: *const c_int, n: *const c_int, x: *mut c_double,
                   ldx: *const c_int, k: *mut c_int);
    pub fn clapmr_(forwrd: *const c_int, m: *const c_int, n: *const c_int, x: *mut c_float_complex,
                   ldx: *const c_int, k: *mut c_int);
    pub fn zlapmr_(forwrd: *const c_int, m: *const c_int, n: *const c_int,
                   x: *mut c_double_complex, ldx: *const c_int, k: *mut c_int);
    ...
    pub fn cbbcsd_(jobu1: *const c_char, jobu2: *const c_char, jobv1t: *const c_char,
                   jobv2t: *const c_char, trans: *const c_char, m: *const c_int, p: *const c_int,
                   q: *const c_int, theta: *mut c_float, phi: *mut c_float,
                   u1: *mut c_float_complex, ldu1: *const c_int, u2: *mut c_float_complex,
                   ldu2: *const c_int, v1t: *mut c_float_complex, ldv1t: *const c_int,
                   v2t: *mut c_float_complex, ldv2t: *const c_int, b11d: *mut c_float,
                   b11e: *mut c_float, b12d: *mut c_float, b12e: *mut c_float, b21d: *mut c_float,
                   b21e: *mut c_float, b22d: *mut c_float, b22e: *mut c_float, rwork: *mut c_float,
                   lrwork: *const c_int, info: *mut c_int);
    pub fn zbbcsd_(jobu1: *const c_char, jobu2: *const c_char, jobv1t: *const c_char,
                   ...
                   u1: *mut c_double_complex, ldu1: *const c_int, u2: *mut c_double_complex,
                   ldu2: *const c_int, v1t: *mut c_double_complex, ldv1t: *const c_int,
                   v2t: *mut c_double_complex, ldv2t: *const c_int, b11d: *mut c_double,
    ...
    pub fn cheswapr_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                     i1: *const c_int, i2: *const c_int);
    pub fn zheswapr_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                     i1: *const c_int, i2: *const c_int);

    pub fn chetri2_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                    lda: *const c_int, ipiv: *const c_int, work: *mut c_float_complex,
                    lwork: *const c_int, info: *mut c_int);
    pub fn zhetri2_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                    lda: *const c_int, ipiv: *const c_int, work: *mut c_double_complex,
                    lwork: *const c_int, info: *mut c_int);

    pub fn chetri2x_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                     lda: *const c_int, ipiv: *const c_int, work: *mut c_float_complex,
                     nb: *const c_int, info: *mut c_int);
    pub fn zhetri2x_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                     lda: *const c_int, ipiv: *const c_int, work: *mut c_double_complex,
                     nb: *const c_int, info: *mut c_int);
    ...
    pub fn csyconv_(uplo: *const c_char, way: *const c_char, n: *const c_int,
                    a: *mut c_float_complex, lda: *const c_int, ipiv: *const c_int,
                    work: *mut c_float_complex, info: *mut c_int);
    pub fn zsyconv_(uplo: *const c_char, way: *const c_char, n: *const c_int,
                    a: *mut c_double_complex, lda: *const c_int, ipiv: *const c_int,
                    work: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn dsyswapr_(uplo: *const c_char, n: *const c_int, a: *mut c_double, i1: *const c_int,
                     i2: *const c_int);
    pub fn csyswapr_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                     i1: *const c_int, i2: *const c_int);
    pub fn zsyswapr_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                     i1: *const c_int, i2: *const c_int);

    pub fn ssytri2_(uplo: *const c_char, n: *const c_int, a: *mut c_float, lda: *const c_int,
                    ipiv: *const c_int, work: *mut c_float_complex, lwork: *const c_int,
                    info: *mut c_int);
    pub fn dsytri2_(uplo: *const c_char, n: *const c_int, a: *mut c_double, lda: *const c_int,
                    ipiv: *const c_int, work: *mut c_double_complex, lwork: *const c_int,
                    info: *mut c_int);
    pub fn csytri2_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                    lda: *const c_int, ipiv: *const c_int, work: *mut c_float_complex,
                    lwork: *const c_int, info: *mut c_int);
    pub fn zsytri2_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                    lda: *const c_int, ipiv: *const c_int, work: *mut c_double_complex,
                    lwork: *const c_int, info: *mut c_int);
    ...
    pub fn csytri2x_(uplo: *const c_char, n: *const c_int, a: *mut c_float_complex,
                     lda: *const c_int, ipiv: *const c_int, work: *mut c_float_complex,
                     nb: *const c_int, info: *mut c_int);
    pub fn zsytri2x_(uplo: *const c_char, n: *const c_int, a: *mut c_double_complex,
                     lda: *const c_int, ipiv: *const c_int, work: *mut c_double_complex,
                     nb: *const c_int, info: *mut c_int);
    ...
    pub fn cunbdb_(trans: *const c_char, signs: *const c_char, m: *const c_int, p: *const c_int,
                   q: *const c_int, x11: *mut c_float_complex, ldx11: *const c_int,
                   x12: *mut c_float_complex, ldx12: *const c_int, x21: *mut c_float_complex,
                   ldx21: *const c_int, x22: *mut c_float_complex, ldx22: *const c_int,
                   theta: *mut c_float, phi: *mut c_float, taup1: *mut c_float_complex,
                   taup2: *mut c_float_complex, tauq1: *mut c_float_complex,
                   tauq2: *mut c_float_complex, work: *mut c_float_complex, lwork: *const c_int,
                   info: *mut c_int);
    pub fn zunbdb_(trans: *const c_char, signs: *const c_char, m: *const c_int, p: *const c_int,
                   q: *const c_int, x11: *mut c_double_complex, ldx11: *const c_int,
                   x12: *mut c_double_complex, ldx12: *const c_int, x21: *mut c_double_complex,
                   ldx21: *const c_int, x22: *mut c_double_complex, ldx22: *const c_int,
                   theta: *mut c_double, phi: *mut c_double, taup1: *mut c_double_complex,
                   taup2: *mut c_double_complex, tauq1: *mut c_double_complex,
                   tauq2: *mut c_double_complex, work: *mut c_double_complex, lwork: *const c_int,
                   info: *mut c_int);
    ...
    pub fn cuncsd_(jobu1: *const c_char, jobu2: *const c_char, jobv1t: *const c_char,
                   ...
                   m: *const c_int, p: *const c_int, q: *const c_int, x11: *mut c_float_complex,
                   ...
                   ldu1: *const c_int, u2: *mut c_float_complex, ldu2: *const c_int,
                   v1t: *mut c_float_complex, ldv1t: *const c_int, v2t: *mut c_float_complex,
                   ldv2t: *const c_int, work: *mut c_float_complex, lwork: *const c_int,
    ...
    pub fn zuncsd_(jobu1: *const c_char, jobu2: *const c_char, jobv1t: *const c_char,
                   jobv2t: *const c_char, trans: *const c_char, signs: *const c_char,
                   m: *const c_int, p: *const c_int, q: *const c_int, x11: *mut c_double_complex,
    ...
    pub fn cgemqrt_(side: *const c_char, trans: *const c_char, m: *const c_int, n: *const c_int,
                    k: *const c_int, nb: *const c_int, v: *const c_float_complex,
                    ldv: *const c_int, t: *const c_float_complex, ldt: *const c_int,
                    c: *mut c_float_complex, ldc: *const c_int, work: *mut c_float_complex,
                    info: *mut c_int);
    pub fn zgemqrt_(side: *const c_char, trans: *const c_char, m: *const c_int, n: *const c_int,
                    k: *const c_int, nb: *const c_int, v: *const c_double_complex,
                    ldv: *const c_int, t: *const c_double_complex, ldt: *const c_int,
                    c: *mut c_double_complex, ldc: *const c_int, work: *mut c_double_complex,
                    info: *mut c_int);
    ...
    pub fn dgeqrt_(m: *const c_int, n: *const c_int, nb: *const c_int, a: *mut c_double,
                   ...
                   info: *mut c_int);
    pub fn cgeqrt_(m: *const c_int, n: *const c_int, nb: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, t: *mut c_float_complex, ldt: *const c_int,
                   work: *mut c_float_complex, info: *mut c_int);
    pub fn zgeqrt_(m: *const c_int, n: *const c_int, nb: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, t: *mut c_double_complex, ldt: *const c_int,
                   work: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn cgeqrt2_(m: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                    t: *mut c_float_complex, ldt: *const c_int, info: *mut c_int);
    pub fn zgeqrt2_(m: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                    t: *mut c_double_complex, ldt: *const c_int, info: *mut c_int);
    ...
    pub fn dgeqrt3_(m: *const c_int, n: *const c_int, a: *mut c_double, lda: *const c_int,
                    t: *mut c_double, ldt: *const c_int, info: *mut c_int);
    pub fn cgeqrt3_(m: *const c_int, n: *const c_int, a: *mut c_float_complex, lda: *const c_int,
                    t: *mut c_float_complex, ldt: *const c_int, info: *mut c_int);
    pub fn zgeqrt3_(m: *const c_int, n: *const c_int, a: *mut c_double_complex, lda: *const c_int,
                    t: *mut c_double_complex, ldt: *const c_int, info: *mut c_int);
    ...
    pub fn ctpmqrt_(side: *const c_char, trans: *const c_char, m: *const c_int, n: *const c_int,
                    k: *const c_int, l: *const c_int, nb: *const c_int, v: *const c_float_complex,
                    ldv: *const c_int, t: *const c_float_complex, ldt: *const c_int,
                    a: *mut c_float_complex, lda: *const c_int, b: *mut c_float_complex,
                    ldb: *const c_int, work: *mut c_float_complex, info: *mut c_int);
    pub fn ztpmqrt_(side: *const c_char, trans: *const c_char, m: *const c_int, n: *const c_int,
                    k: *const c_int, l: *const c_int, nb: *const c_int, v: *const c_double_complex,
                    ldv: *const c_int, t: *const c_double_complex, ldt: *const c_int,
                    a: *mut c_double_complex, lda: *const c_int, b: *mut c_double_complex,
                    ldb: *const c_int, work: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn ctpqrt_(m: *const c_int, n: *const c_int, l: *const c_int, nb: *const c_int,
                   a: *mut c_float_complex, lda: *const c_int, b: *mut c_float_complex,
                   ldb: *const c_int, t: *mut c_float_complex, ldt: *const c_int,
                   work: *mut c_float_complex, info: *mut c_int);
    pub fn ztpqrt_(m: *const c_int, n: *const c_int, l: *const c_int, nb: *const c_int,
                   a: *mut c_double_complex, lda: *const c_int, b: *mut c_double_complex,
                   ldb: *const c_int, t: *mut c_double_complex, ldt: *const c_int,
                   work: *mut c_double_complex, info: *mut c_int);
    ...
    pub fn dtpqrt2_(m: *const c_int, n: *const c_int, l: *const c_int, a: *mut c_double,
                    ...
                    ldt: *const c_int, info: *mut c_int);
    pub fn ctpqrt2_(m: *const c_int, n: *const c_int, l: *const c_int, a: *mut c_float_complex,
                    lda: *const c_int, b: *mut c_float_complex, ldb: *const c_int,
                    t: *mut c_float_complex, ldt: *const c_int, info: *mut c_int);
    pub fn ztpqrt2_(m: *const c_int, n: *const c_int, l: *const c_int, a: *mut c_double_complex,
                    lda: *const c_int, b: *mut c_double_complex, ldb: *const c_int,
                    t: *mut c_double_complex, ldt: *const c_int, info: *mut c_int);
    ...
    pub fn ctprfb_(side: *const c_char, trans: *const c_char, direct: *const c_char,
                   storev: *const c_char, m: *const c_int, n: *const c_int, k: *const c_int,
                   l: *const c_int, v: *const c_float_complex, ldv: *const c_int,
                   t: *const c_float_complex, ldt: *const c_int, a: *mut c_float_complex,
                   lda: *const c_int, b: *mut c_float_complex, ldb: *const c_int,
                   work: *const c_float, ldwork: *const c_int);
    pub fn ztprfb_(side: *const c_char, trans: *const c_char, direct: *const c_char,
                   storev: *const c_char, m: *const c_int, n: *const c_int, k: *const c_int,
                   l: *const c_int, v: *const c_double_complex, ldv: *const c_int,
                   t: *const c_double_complex, ldt: *const c_int, a: *mut c_double_complex,
                   lda: *const c_int, b: *mut c_double_complex, ldb: *const c_int,
    ...
    pub fn csyr_(uplo: *const c_char, n: *const c_int, alpha: *const c_float_complex,
                 x: *const c_float_complex, incx: *const c_int, a: *mut c_float_complex,
                 lda: *const c_int);
    pub fn zsyr_(uplo: *const c_char, n: *const c_int, alpha: *const c_double_complex,
